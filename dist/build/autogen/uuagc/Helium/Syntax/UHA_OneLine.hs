...
wrap_Alternative !(T_Alternative act) !(Inh_Alternative ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Alternative_vOut1 _lhsOoneLineTree _lhsOself) <- return (inv_Alternative_s2 sem arg1)
...
wrap_Alternatives !(T_Alternatives act) !(Inh_Alternatives ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Alternatives_vOut4 _lhsOoneLineTree _lhsOself) <- return (inv_Alternatives_s5 sem arg4)
...
wrap_Declaration !(T_Declaration act) !(Inh_Declaration ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Declaration_vOut28 _lhsOoneLineTree _lhsOself) <- return (inv_Declaration_s29 sem arg28)
...
sem_Declaration_Instance arg_range_ arg_context_ arg_name_ arg_types_ arg_where_ = T_Declaration (return st29) where
   ...
   !st29 = let
      ...
      v28 = \ !(T_Declaration_vIn28 ) -> ( let
         ...
         (T_Types_vOut166 _typesIself) = inv_Types_s167 _typesX167 (T_Types_vIn166 )
         (T_MaybeDeclarations_vOut88 _whereIoneLineTree _whereIself) = inv_MaybeDeclarations_s89 _whereX89 (T_MaybeDeclarations_vIn88 )
         _oneLineTree = rule67 _nameIself
     ...
     in C_Declaration_s29 v28
   {-# INLINE rule67 #-}
   rule67 = \ ((_nameIself) :: Name) ->
                                            OneLineText $ "instance " ++ show _nameIself
   {-# INLINE rule68 #-}
...
wrap_Declarations !(T_Declarations act) !(Inh_Declarations ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Declarations_vOut31 _lhsOoneLineTree _lhsOself) <- return (inv_Declarations_s32 sem arg31)
...
wrap_Expression !(T_Expression act) !(Inh_Expression ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Expression_vOut40 _lhsOoneLineTree _lhsOself) <- return (inv_Expression_s41 sem arg40)
...
sem_Expression_Eta arg_range_ !arg_expansion_ arg_expression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule123 _expressionIself _rangeIself arg_expansion_
         _lhsOself :: Expression
         _lhsOself = rule124 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule125 _expressionIoneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule123 #-}
   rule123 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) expansion_ ->
     Expression_Eta _rangeIself expansion_ _expressionIself
   {-# INLINE rule124 #-}
   rule124 = \ _self ->
     _self
   {-# INLINE rule125 #-}
   rule125 = \ ((_expressionIoneLineTree) :: OneLineTree) ->
     _expressionIoneLineTree
...
sem_Expression_Literal arg_range_ arg_literal_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _oneLineTree = rule126 _literalIoneLineTree
         _self = rule127 _literalIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule128 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule129 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule126 #-}
   rule126 = \ ((_literalIoneLineTree) :: OneLineTree) ->
                                            OneLineNode [_literalIoneLineTree]
   {-# INLINE rule127 #-}
   rule127 = \ ((_literalIself) :: Literal) ((_rangeIself) :: Range) ->
     Expression_Literal _rangeIself _literalIself
   {-# INLINE rule128 #-}
   rule128 = \ _self ->
     _self
   {-# INLINE rule129 #-}
   rule129 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Variable arg_range_ arg_name_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _oneLineTree = rule130 _nameIoneLineTree
         _self = rule131 _nameIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule132 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule133 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule130 #-}
   rule130 = \ ((_nameIoneLineTree) :: OneLineTree) ->
                                            OneLineNode [_nameIoneLineTree]
   {-# INLINE rule131 #-}
   rule131 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
     Expression_Variable _rangeIself _nameIself
   {-# INLINE rule132 #-}
   rule132 = \ _self ->
     _self
   {-# INLINE rule133 #-}
   rule133 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Constructor arg_range_ arg_name_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _oneLineTree = rule134 _nameIoneLineTree
         _self = rule135 _nameIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule136 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule137 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule134 #-}
   rule134 = \ ((_nameIoneLineTree) :: OneLineTree) ->
                                            OneLineNode [_nameIoneLineTree]
   {-# INLINE rule135 #-}
   rule135 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
     Expression_Constructor _rangeIself _nameIself
   {-# INLINE rule136 #-}
   rule136 = \ _self ->
     _self
   {-# INLINE rule137 #-}
   rule137 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Parenthesized arg_range_ arg_expression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _oneLineTree = rule138 _expressionIoneLineTree
         _self = rule139 _expressionIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule140 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule141 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule138 #-}
   rule138 = \ ((_expressionIoneLineTree) :: OneLineTree) ->
                                            parens _expressionIoneLineTree
   {-# INLINE rule139 #-}
   rule139 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ->
     Expression_Parenthesized _rangeIself _expressionIself
   {-# INLINE rule140 #-}
   rule140 = \ _self ->
     _self
   {-# INLINE rule141 #-}
   rule141 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_NormalApplication arg_range_ arg_function_ arg_arguments_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _oneLineTree = rule142 _argumentsIoneLineTree _functionIoneLineTree
         _self = rule143 _argumentsIself _functionIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule144 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule145 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule142 #-}
   rule142 = \ ((_argumentsIoneLineTree) ::  [ OneLineTree] ) ((_functionIoneLineTree) :: OneLineTree) ->
              punctuate " " (_functionIoneLineTree : _argumentsIoneLineTree)
   {-# INLINE rule143 #-}
   rule143 = \ ((_argumentsIself) :: Expressions) ((_functionIself) :: Expression) ((_rangeIself) :: Range) ->
     Expression_NormalApplication _rangeIself _functionIself _argumentsIself
   {-# INLINE rule144 #-}
   rule144 = \ _self ->
     _self
   {-# INLINE rule145 #-}
   rule145 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_InfixApplication arg_range_ arg_leftExpression_ arg_operator_ arg_rightExpression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _operatorName = rule146 _operatorIoneLineTree
         _oneLineTree = rule147 _leftExpressionIoneLineTree _operatorName _rightExpressionIoneLineTree
         _self = rule148 _leftExpressionIself _operatorIself _rangeIself _rightExpressionIself
         _lhsOself :: Expression
         _lhsOself = rule149 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule150 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule146 #-}
   rule146 = \ ((_operatorIoneLineTree) :: OneLineTree) ->
                                             oneLineTreeAsOperator _operatorIoneLineTree
   {-# INLINE rule147 #-}
   rule147 = \ ((_leftExpressionIoneLineTree) ::  Maybe OneLineTree ) _operatorName ((_rightExpressionIoneLineTree) ::  Maybe OneLineTree ) ->
   ...
   {-# INLINE rule148 #-}
   rule148 = \ ((_leftExpressionIself) :: MaybeExpression) ((_operatorIself) :: Expression) ((_rangeIself) :: Range) ((_rightExpressionIself) :: MaybeExpression) ->
     Expression_InfixApplication _rangeIself _leftExpressionIself _operatorIself _rightExpressionIself
   {-# INLINE rule149 #-}
   rule149 = \ _self ->
     _self
   {-# INLINE rule150 #-}
   rule150 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_If arg_range_ arg_guardExpression_ arg_thenExpression_ arg_elseExpression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _oneLineTree = rule151 _elseExpressionIoneLineTree _guardExpressionIoneLineTree _thenExpressionIoneLineTree
         _self = rule152 _elseExpressionIself _guardExpressionIself _rangeIself _thenExpressionIself
         _lhsOself :: Expression
         _lhsOself = rule153 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule154 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule151 #-}
   rule151 = \ ((_elseExpressionIoneLineTree) :: OneLineTree) ((_guardExpressionIoneLineTree) :: OneLineTree) ((_thenExpressionIoneLineTree) :: OneLineTree) ->
              OneLineNode
                  [ OneLineText "if "
   ...
   {-# INLINE rule152 #-}
   rule152 = \ ((_elseExpressionIself) :: Expression) ((_guardExpressionIself) :: Expression) ((_rangeIself) :: Range) ((_thenExpressionIself) :: Expression) ->
     Expression_If _rangeIself _guardExpressionIself _thenExpressionIself _elseExpressionIself
   {-# INLINE rule153 #-}
   rule153 = \ _self ->
     _self
   {-# INLINE rule154 #-}
   rule154 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Lambda arg_range_ arg_patterns_ arg_expression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _oneLineTree = rule155 _expressionIoneLineTree _patternsIoneLineTree
         _self = rule156 _expressionIself _patternsIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule157 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule158 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule155 #-}
   rule155 = \ ((_expressionIoneLineTree) :: OneLineTree) ((_patternsIoneLineTree) ::  [ OneLineTree] ) ->
                  OneLineNode
   ...
   {-# INLINE rule156 #-}
   rule156 = \ ((_expressionIself) :: Expression) ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
     Expression_Lambda _rangeIself _patternsIself _expressionIself
   {-# INLINE rule157 #-}
   rule157 = \ _self ->
     _self
   {-# INLINE rule158 #-}
   rule158 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Case arg_range_ arg_expression_ arg_alternatives_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _oneLineTree = rule159 _alternativesIoneLineTree _expressionIoneLineTree
         _self = rule160 _alternativesIself _expressionIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule161 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule162 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule159 #-}
   rule159 = \ ((_alternativesIoneLineTree) ::  [ OneLineTree] ) ((_expressionIoneLineTree) :: OneLineTree) ->
                  OneLineNode
                      [ OneLineText "case "
                      , OneLineNode [_expressionIoneLineTree]
                      , OneLineText " of "
   ...
   {-# INLINE rule160 #-}
   rule160 = \ ((_alternativesIself) :: Alternatives) ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ->
     Expression_Case _rangeIself _expressionIself _alternativesIself
   {-# INLINE rule161 #-}
   rule161 = \ _self ->
     _self
   {-# INLINE rule162 #-}
   rule162 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Let arg_range_ arg_declarations_ arg_expression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Declarations_vOut31 _declarationsIoneLineTree _declarationsIself) = inv_Declarations_s32 _declarationsX32 (T_Declarations_vIn31 )
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _oneLineTree = rule163 _declarationsIoneLineTree _expressionIoneLineTree
         _self = rule164 _declarationsIself _expressionIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule165 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule166 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule163 #-}
   rule163 = \ ((_declarationsIoneLineTree) ::  [ OneLineTree] ) ((_expressionIoneLineTree) :: OneLineTree) ->
                  OneLineNode
                      [ OneLineText "let "
   ...
   {-# INLINE rule164 #-}
   rule164 = \ ((_declarationsIself) :: Declarations) ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ->
     Expression_Let _rangeIself _declarationsIself _expressionIself
   {-# INLINE rule165 #-}
   rule165 = \ _self ->
     _self
   {-# INLINE rule166 #-}
   rule166 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Do arg_range_ arg_statements_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _oneLineTree = rule167 _statementsIoneLineTree
         _self = rule168 _rangeIself _statementsIself
         _lhsOself :: Expression
         _lhsOself = rule169 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule170 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule167 #-}
   rule167 = \ ((_statementsIoneLineTree) ::  [ OneLineTree] ) ->
                  OneLineNode
                      [ OneLineText "do "
                      , OneLineNode (sepBy (OneLineText "; ") _statementsIoneLineTree)
                      ]
   {-# INLINE rule168 #-}
   rule168 = \ ((_rangeIself) :: Range) ((_statementsIself) :: Statements) ->
     Expression_Do _rangeIself _statementsIself
   {-# INLINE rule169 #-}
   rule169 = \ _self ->
     _self
   {-# INLINE rule170 #-}
   rule170 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_List arg_range_ arg_expressions_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _oneLineTree = rule171 _expressionsIoneLineTree
         _self = rule172 _expressionsIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule173 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule174 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule171 #-}
   rule171 = \ ((_expressionsIoneLineTree) ::  [ OneLineTree] ) ->
                                encloseSep "[" ", " "]" _expressionsIoneLineTree
   {-# INLINE rule172 #-}
   rule172 = \ ((_expressionsIself) :: Expressions) ((_rangeIself) :: Range) ->
     Expression_List _rangeIself _expressionsIself
   {-# INLINE rule173 #-}
   rule173 = \ _self ->
     _self
   {-# INLINE rule174 #-}
   rule174 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Tuple arg_range_ arg_expressions_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expressions_vOut43 _expressionsIoneLineTree _expressionsIself) = inv_Expressions_s44 _expressionsX44 (T_Expressions_vIn43 )
         _oneLineTree = rule175 _expressionsIoneLineTree
         _self = rule176 _expressionsIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule177 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule178 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule175 #-}
   rule175 = \ ((_expressionsIoneLineTree) ::  [ OneLineTree] ) ->
                                encloseSep "(" ", " ")" _expressionsIoneLineTree
   {-# INLINE rule176 #-}
   rule176 = \ ((_expressionsIself) :: Expressions) ((_rangeIself) :: Range) ->
     Expression_Tuple _rangeIself _expressionsIself
   {-# INLINE rule177 #-}
   rule177 = \ _self ->
     _self
   {-# INLINE rule178 #-}
   rule178 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Comprehension arg_range_ arg_expression_ arg_qualifiers_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _oneLineTree = rule179 _expressionIoneLineTree _qualifiersIoneLineTree
         _self = rule180 _expressionIself _qualifiersIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule181 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule182 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule179 #-}
   rule179 = \ ((_expressionIoneLineTree) :: OneLineTree) ((_qualifiersIoneLineTree) ::  [ OneLineTree] ) ->
                  OneLineNode
                      [ OneLineText "[ "
                      , OneLineNode [_expressionIoneLineTree]
                      , OneLineText " | "
   ...
   {-# INLINE rule180 #-}
   rule180 = \ ((_expressionIself) :: Expression) ((_qualifiersIself) :: Qualifiers) ((_rangeIself) :: Range) ->
     Expression_Comprehension _rangeIself _expressionIself _qualifiersIself
   {-# INLINE rule181 #-}
   rule181 = \ _self ->
     _self
   {-# INLINE rule182 #-}
   rule182 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Typed arg_range_ arg_expression_ arg_type_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         (T_Type_vOut163 _typeIself) = inv_Type_s164 _typeX164 (T_Type_vIn163 )
         _oneLineTree = rule183 _expressionIoneLineTree _typeIself
         _self = rule184 _expressionIself _rangeIself _typeIself
         _lhsOself :: Expression
         _lhsOself = rule185 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule186 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule183 #-}
   rule183 = \ ((_expressionIoneLineTree) :: OneLineTree) ((_typeIself) :: Type) ->
                  OneLineNode
                      [ OneLineNode [_expressionIoneLineTree]
                      , OneLineText " :: "
   ...
   {-# INLINE rule184 #-}
   rule184 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ((_typeIself) :: Type) ->
     Expression_Typed _rangeIself _expressionIself _typeIself
   {-# INLINE rule185 #-}
   rule185 = \ _self ->
     _self
   {-# INLINE rule186 #-}
   rule186 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_RecordConstruction arg_range_ arg_name_ arg_recordExpressionBindings_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _oneLineTree = rule187  ()
         _self = rule188 _nameIself _rangeIself _recordExpressionBindingsIself
         _lhsOself :: Expression
         _lhsOself = rule189 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule190 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule187 #-}
   ...
   {-# INLINE rule188 #-}
   rule188 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ((_recordExpressionBindingsIself) :: RecordExpressionBindings) ->
     Expression_RecordConstruction _rangeIself _nameIself _recordExpressionBindingsIself
   {-# INLINE rule189 #-}
   rule189 = \ _self ->
     _self
   {-# INLINE rule190 #-}
   rule190 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_RecordUpdate arg_range_ arg_expression_ arg_recordExpressionBindings_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         (T_RecordExpressionBindings_vOut139 _recordExpressionBindingsIself) = inv_RecordExpressionBindings_s140 _recordExpressionBindingsX140 (T_RecordExpressionBindings_vIn139 )
         _oneLineTree = rule191  ()
         _self = rule192 _expressionIself _rangeIself _recordExpressionBindingsIself
         _lhsOself :: Expression
         _lhsOself = rule193 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule194 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule191 #-}
   ...
   {-# INLINE rule192 #-}
   rule192 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ((_recordExpressionBindingsIself) :: RecordExpressionBindings) ->
     Expression_RecordUpdate _rangeIself _expressionIself _recordExpressionBindingsIself
   {-# INLINE rule193 #-}
   rule193 = \ _self ->
     _self
   {-# INLINE rule194 #-}
   rule194 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Enum arg_range_ arg_from_ arg_then_ arg_to_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _oneLineTree = rule195 _fromIoneLineTree _thenIoneLineTree _toIoneLineTree
         _self = rule196 _fromIself _rangeIself _thenIself _toIself
         _lhsOself :: Expression
         _lhsOself = rule197 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule198 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule195 #-}
   rule195 = \ ((_fromIoneLineTree) :: OneLineTree) ((_thenIoneLineTree) ::  Maybe OneLineTree ) ((_toIoneLineTree) ::  Maybe OneLineTree ) ->
                  OneLineNode (
                      [ OneLineText "["
   ...
   {-# INLINE rule196 #-}
   rule196 = \ ((_fromIself) :: Expression) ((_rangeIself) :: Range) ((_thenIself) :: MaybeExpression) ((_toIself) :: MaybeExpression) ->
     Expression_Enum _rangeIself _fromIself _thenIself _toIself
   {-# INLINE rule197 #-}
   rule197 = \ _self ->
     _self
   {-# INLINE rule198 #-}
   rule198 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_Negate arg_range_ arg_expression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _oneLineTree = rule199 _expressionIoneLineTree
         _self = rule200 _expressionIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule201 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule202 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule199 #-}
   rule199 = \ ((_expressionIoneLineTree) :: OneLineTree) ->
                                OneLineNode [ OneLineText "-", OneLineNode [_expressionIoneLineTree] ]
   {-# INLINE rule200 #-}
   rule200 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ->
     Expression_Negate _rangeIself _expressionIself
   {-# INLINE rule201 #-}
   rule201 = \ _self ->
     _self
   {-# INLINE rule202 #-}
   rule202 = \ _oneLineTree ->
     _oneLineTree
...
sem_Expression_NegateFloat arg_range_ arg_expression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _oneLineTree = rule203 _expressionIoneLineTree
         _self = rule204 _expressionIself _rangeIself
         _lhsOself :: Expression
         _lhsOself = rule205 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule206 _oneLineTree
         !__result_ = T_Expression_vOut40 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Expression_s41 v40
   {-# INLINE rule203 #-}
   rule203 = \ ((_expressionIoneLineTree) :: OneLineTree) ->
                                OneLineNode [ OneLineText "-.", OneLineNode [_expressionIoneLineTree] ]
   {-# INLINE rule204 #-}
   rule204 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ->
     Expression_NegateFloat _rangeIself _expressionIself
   {-# INLINE rule205 #-}
   rule205 = \ _self ->
     _self
   {-# INLINE rule206 #-}
   rule206 = \ _oneLineTree ->
     _oneLineTree
...
wrap_Expressions !(T_Expressions act) !(Inh_Expressions ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Expressions_vOut43 _lhsOoneLineTree _lhsOself) <- return (inv_Expressions_s44 sem arg43)
...
sem_Expressions_Cons arg_hd_ arg_tl_ = T_Expressions (return st44) where
   ...
   !st44 = let
      ...
      v43 = \ !(T_Expressions_vIn43 ) -> ( let
         ...
         _lhsOoneLineTree ::  [ OneLineTree] 
         _lhsOoneLineTree = rule207 _hdIoneLineTree _tlIoneLineTree
   ...
   {-# INLINE rule207 #-}
   rule207 = \ ((_hdIoneLineTree) :: OneLineTree) ((_tlIoneLineTree) ::  [ OneLineTree] ) ->
     _hdIoneLineTree  :  _tlIoneLineTree
   {-# INLINE rule208 #-}
   rule208 = \ ((_hdIself) :: Expression) ((_tlIself) :: Expressions) ->
     (:) _hdIself _tlIself
   {-# INLINE rule209 #-}
   rule209 = \ _self ->
     _self
...
sem_FieldDeclaration_FieldDeclaration arg_range_ arg_names_ arg_type_ = T_FieldDeclaration (return st47) where
   ...
   !st47 = let
      ...
      v46 = \ !(T_FieldDeclaration_vIn46 ) -> ( let
         ...
         _self = rule213 _namesIself _rangeIself _typeIself
   ...
   {-# INLINE rule213 #-}
   rule213 = \ ((_namesIself) :: Names) ((_rangeIself) :: Range) ((_typeIself) :: AnnotatedType) ->
...
sem_FieldDeclarations_Cons arg_hd_ arg_tl_ = T_FieldDeclarations (return st50) where
   ...
   !st50 = let
      ...
      v49 = \ !(T_FieldDeclarations_vIn49 ) -> ( let
         ...
         _self = rule215 _hdIself _tlIself
   ...
   {-# INLINE rule215 #-}
   rule215 = \ ((_hdIself) :: FieldDeclaration) ((_tlIself) :: FieldDeclarations) ->
     (:) _hdIself _tlIself
   {-# INLINE rule216 #-}
   rule216 = \ _self ->
     _self
...
wrap_FunctionBinding !(T_FunctionBinding act) !(Inh_FunctionBinding ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_FunctionBinding_vOut55 _lhsOoneLineTree _lhsOself) <- return (inv_FunctionBinding_s56 sem arg55)
...
sem_FunctionBinding_Feedback arg_range_ !arg_feedback_ arg_functionBinding_ = T_FunctionBinding (return st56) where
   ...
   !st56 = let
      ...
      v55 = \ !(T_FunctionBinding_vIn55 ) -> ( let
         ...
         _self = rule229 _functionBindingIself _rangeIself arg_feedback_
         _lhsOself :: FunctionBinding
         _lhsOself = rule230 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule231 _functionBindingIoneLineTree
         !__result_ = T_FunctionBinding_vOut55 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_FunctionBinding_s56 v55
   {-# INLINE rule229 #-}
   rule229 = \ ((_functionBindingIself) :: FunctionBinding) ((_rangeIself) :: Range) feedback_ ->
     FunctionBinding_Feedback _rangeIself feedback_ _functionBindingIself
   {-# INLINE rule230 #-}
   rule230 = \ _self ->
     _self
   {-# INLINE rule231 #-}
   rule231 = \ ((_functionBindingIoneLineTree) :: OneLineTree) ->
...
sem_FunctionBinding_FunctionBinding arg_range_ arg_lefthandside_ arg_righthandside_ = T_FunctionBinding (return st56) where
   ...
   !st56 = let
      ...
      v55 = \ !(T_FunctionBinding_vIn55 ) -> ( let
         ...
         (T_RightHandSide_vOut148 _righthandsideIoneLineTree _righthandsideIself) = inv_RightHandSide_s149 _righthandsideX149 (T_RightHandSide_vIn148 )
         _oneLineTree = rule232 _lefthandsideIoneLineTree _righthandsideIoneLineTree
         _self = rule233 _lefthandsideIself _rangeIself _righthandsideIself
         _lhsOself :: FunctionBinding
         _lhsOself = rule234 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule235 _oneLineTree
         !__result_ = T_FunctionBinding_vOut55 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_FunctionBinding_s56 v55
   {-# INLINE rule232 #-}
   rule232 = \ ((_lefthandsideIoneLineTree) :: OneLineTree) ((_righthandsideIoneLineTree) ::  String -> OneLineTree ) ->
              OneLineNode [_lefthandsideIoneLineTree, _righthandsideIoneLineTree " = " ]
   {-# INLINE rule233 #-}
   rule233 = \ ((_lefthandsideIself) :: LeftHandSide) ((_rangeIself) :: Range) ((_righthandsideIself) :: RightHandSide) ->
     FunctionBinding_FunctionBinding _rangeIself _lefthandsideIself _righthandsideIself
   {-# INLINE rule234 #-}
   rule234 = \ _self ->
     _self
   {-# INLINE rule235 #-}
   rule235 = \ _oneLineTree ->
     _oneLineTree
...
wrap_FunctionBindings !(T_FunctionBindings act) !(Inh_FunctionBindings ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_FunctionBindings_vOut58 _lhsOoneLineTree _lhsOself) <- return (inv_FunctionBindings_s59 sem arg58)
...
sem_FunctionBindings_Cons arg_hd_ arg_tl_ = T_FunctionBindings (return st59) where
   ...
   !st59 = let
      ...
      v58 = \ !(T_FunctionBindings_vIn58 ) -> ( let
         ...
         _lhsOoneLineTree ::  [ OneLineTree] 
         _lhsOoneLineTree = rule236 _hdIoneLineTree _tlIoneLineTree
         _self = rule237 _hdIself _tlIself
   ...
   {-# INLINE rule236 #-}
   rule236 = \ ((_hdIoneLineTree) :: OneLineTree) ((_tlIoneLineTree) ::  [ OneLineTree] ) ->
     _hdIoneLineTree  :  _tlIoneLineTree
   {-# INLINE rule237 #-}
   rule237 = \ ((_hdIself) :: FunctionBinding) ((_tlIself) :: FunctionBindings) ->
     (:) _hdIself _tlIself
   {-# INLINE rule238 #-}
   rule238 = \ _self ->
     _self
...
wrap_GuardedExpression !(T_GuardedExpression act) !(Inh_GuardedExpression ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_GuardedExpression_vOut61 _lhsOoneLineTree _lhsOself) <- return (inv_GuardedExpression_s62 sem arg61)
...
wrap_GuardedExpressions !(T_GuardedExpressions act) !(Inh_GuardedExpressions ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_GuardedExpressions_vOut64 _lhsOoneLineTree _lhsOself) <- return (inv_GuardedExpressions_s65 sem arg64)
...
sem_GuardedExpressions_Cons arg_hd_ arg_tl_ = T_GuardedExpressions (return st65) where
   ...
   !st65 = let
      ...
      v64 = \ !(T_GuardedExpressions_vIn64 ) -> ( let
         ...
         _lhsOoneLineTree ::  [ String -> OneLineTree ] 
         _lhsOoneLineTree = rule246 _hdIoneLineTree _tlIoneLineTree
         _self = rule247 _hdIself _tlIself
   ...
   {-# INLINE rule246 #-}
   rule246 = \ ((_hdIoneLineTree) ::  String -> OneLineTree ) ((_tlIoneLineTree) ::  [ String -> OneLineTree ] ) ->
     _hdIoneLineTree  :  _tlIoneLineTree
   {-# INLINE rule247 #-}
   rule247 = \ ((_hdIself) :: GuardedExpression) ((_tlIself) :: GuardedExpressions) ->
     (:) _hdIself _tlIself
   {-# INLINE rule248 #-}
   rule248 = \ _self ->
     _self
...
sem_Import_Variable arg_range_ arg_name_ = T_Import (return st68) where
   ...
   !st68 = let
      ...
      v67 = \ !(T_Import_vIn67 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _self = rule252 _nameIself _rangeIself
         _lhsOself :: Import
     ...
     in C_Import_s68 v67
   {-# INLINE rule252 #-}
   rule252 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
...
sem_Import_TypeOrClass arg_range_ arg_name_ arg_names_ = T_Import (return st68) where
   ...
   !st68 = let
      ...
      v67 = \ !(T_Import_vIn67 ) -> ( let
         ...
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_MaybeNames_vOut106 _namesIself) = inv_MaybeNames_s107 _namesX107 (T_MaybeNames_vIn106 )
         _self = rule254 _nameIself _namesIself _rangeIself
         _lhsOself :: Import
     ...
     in C_Import_s68 v67
   {-# INLINE rule254 #-}
   rule254 = \ ((_nameIself) :: Name) ((_namesIself) :: MaybeNames) ((_rangeIself) :: Range) ->
...
sem_Import_TypeOrClassComplete arg_range_ arg_name_ = T_Import (return st68) where
   ...
   !st68 = let
      ...
      v67 = \ !(T_Import_vIn67 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _self = rule256 _nameIself _rangeIself
         _lhsOself :: Import
     ...
     in C_Import_s68 v67
   {-# INLINE rule256 #-}
   rule256 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
...
sem_ImportDeclaration_Import arg_range_ !arg_qualified_ arg_name_ arg_asname_ arg_importspecification_ = T_ImportDeclaration (return st71) where
   ...
   !st71 = let
      ...
      v70 = \ !(T_ImportDeclaration_vIn70 ) -> ( let
         ...
         _self = rule258 _asnameIself _importspecificationIself _nameIself _rangeIself arg_qualified_
   ...
   {-# INLINE rule258 #-}
   rule258 = \ ((_asnameIself) :: MaybeName) ((_importspecificationIself) :: MaybeImportSpecification) ((_nameIself) :: Name) ((_rangeIself) :: Range) qualified_ ->
...
sem_ImportDeclarations_Cons arg_hd_ arg_tl_ = T_ImportDeclarations (return st74) where
   ...
   {-# INLINE rule262 #-}
   rule262 = \ ((_hdIself) :: ImportDeclaration) ((_tlIself) :: ImportDeclarations) ->
     (:) _hdIself _tlIself
   {-# INLINE rule263 #-}
   rule263 = \ _self ->
     _self
...
sem_ImportSpecification_Import arg_range_ !arg_hiding_ arg_imports_ = T_ImportSpecification (return st77) where
   ...
   !st77 = let
      ...
      v76 = \ !(T_ImportSpecification_vIn76 ) -> ( let
         ...
         _self = rule266 _importsIself _rangeIself arg_hiding_
   ...
   {-# INLINE rule266 #-}
   rule266 = \ ((_importsIself) :: Imports) ((_rangeIself) :: Range) hiding_ ->
...
sem_Imports_Cons arg_hd_ arg_tl_ = T_Imports (return st80) where
   ...
   {-# INLINE rule268 #-}
   rule268 = \ ((_hdIself) :: Import) ((_tlIself) :: Imports) ->
     (:) _hdIself _tlIself
   {-# INLINE rule269 #-}
   rule269 = \ _self ->
     _self
...
wrap_LeftHandSide !(T_LeftHandSide act) !(Inh_LeftHandSide ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_LeftHandSide_vOut82 _lhsOoneLineTree _lhsOself) <- return (inv_LeftHandSide_s83 sem arg82)
...
sem_LeftHandSide_Function arg_range_ arg_name_ arg_patterns_ = T_LeftHandSide (return st83) where
   ...
   !st83 = let
      ...
      v82 = \ !(T_LeftHandSide_vIn82 ) -> ( let
         ...
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_Patterns_vOut121 _patternsIoneLineTree _patternsIself) = inv_Patterns_s122 _patternsX122 (T_Patterns_vIn121 )
         _oneLineTree = rule272 _nameIoneLineTree _patternsIoneLineTree
         _self = rule273 _nameIself _patternsIself _rangeIself
         _lhsOself :: LeftHandSide
         _lhsOself = rule274 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule275 _oneLineTree
         !__result_ = T_LeftHandSide_vOut82 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_LeftHandSide_s83 v82
   {-# INLINE rule272 #-}
   rule272 = \ ((_nameIoneLineTree) :: OneLineTree) ((_patternsIoneLineTree) ::  [ OneLineTree] ) ->
                                            punctuate " " (_nameIoneLineTree : _patternsIoneLineTree)
   {-# INLINE rule273 #-}
   rule273 = \ ((_nameIself) :: Name) ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
     LeftHandSide_Function _rangeIself _nameIself _patternsIself
   {-# INLINE rule274 #-}
   rule274 = \ _self ->
     _self
   {-# INLINE rule275 #-}
   rule275 = \ _oneLineTree ->
     _oneLineTree
...
sem_LeftHandSide_Infix arg_range_ arg_leftPattern_ arg_operator_ arg_rightPattern_ = T_LeftHandSide (return st83) where
   ...
   !st83 = let
      ...
      v82 = \ !(T_LeftHandSide_vIn82 ) -> ( let
         ...
         _operatorName = rule276 _operatorIoneLineTree
         _oneLineTree = rule277 _leftPatternIoneLineTree _operatorName _rightPatternIoneLineTree
         _self = rule278 _leftPatternIself _operatorIself _rangeIself _rightPatternIself
         _lhsOself :: LeftHandSide
         _lhsOself = rule279 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule280 _oneLineTree
         !__result_ = T_LeftHandSide_vOut82 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_LeftHandSide_s83 v82
   {-# INLINE rule276 #-}
   rule276 = \ ((_operatorIoneLineTree) :: OneLineTree) ->
                                             oneLineTreeAsOperator _operatorIoneLineTree
   {-# INLINE rule277 #-}
   rule277 = \ ((_leftPatternIoneLineTree) :: OneLineTree) _operatorName ((_rightPatternIoneLineTree) :: OneLineTree) ->
              punctuate " " [_leftPatternIoneLineTree, _operatorName, _rightPatternIoneLineTree]
   {-# INLINE rule278 #-}
   rule278 = \ ((_leftPatternIself) :: Pattern) ((_operatorIself) :: Name) ((_rangeIself) :: Range) ((_rightPatternIself) :: Pattern) ->
     LeftHandSide_Infix _rangeIself _leftPatternIself _operatorIself _rightPatternIself
   {-# INLINE rule279 #-}
   rule279 = \ _self ->
     _self
   {-# INLINE rule280 #-}
   rule280 = \ _oneLineTree ->
     _oneLineTree
...
sem_LeftHandSide_Parenthesized arg_range_ arg_lefthandside_ arg_patterns_ = T_LeftHandSide (return st83) where
   ...
   !st83 = let
      ...
      v82 = \ !(T_LeftHandSide_vIn82 ) -> ( let
         ...
         (T_LeftHandSide_vOut82 _lefthandsideIoneLineTree _lefthandsideIself) = inv_LeftHandSide_s83 _lefthandsideX83 (T_LeftHandSide_vIn82 )
         (T_Patterns_vOut121 _patternsIoneLineTree _patternsIself) = inv_Patterns_s122 _patternsX122 (T_Patterns_vIn121 )
         _oneLineTree = rule281 _lefthandsideIoneLineTree _patternsIoneLineTree
         _self = rule282 _lefthandsideIself _patternsIself _rangeIself
         _lhsOself :: LeftHandSide
         _lhsOself = rule283 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule284 _oneLineTree
         !__result_ = T_LeftHandSide_vOut82 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_LeftHandSide_s83 v82
   {-# INLINE rule281 #-}
   rule281 = \ ((_lefthandsideIoneLineTree) :: OneLineTree) ((_patternsIoneLineTree) ::  [ OneLineTree] ) ->
              punctuate " " ( parens _lefthandsideIoneLineTree : _patternsIoneLineTree )
   {-# INLINE rule282 #-}
   rule282 = \ ((_lefthandsideIself) :: LeftHandSide) ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
     LeftHandSide_Parenthesized _rangeIself _lefthandsideIself _patternsIself
   {-# INLINE rule283 #-}
   rule283 = \ _self ->
     _self
   {-# INLINE rule284 #-}
   rule284 = \ _oneLineTree ->
     _oneLineTree
...
wrap_Literal !(T_Literal act) !(Inh_Literal ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Literal_vOut85 _lhsOoneLineTree _lhsOself) <- return (inv_Literal_s86 sem arg85)
...
sem_Literal_Int arg_range_ !arg_value_ = T_Literal (return st86) where
   ...
   !st86 = let
      ...
      v85 = \ !(T_Literal_vIn85 ) -> ( let
         _rangeX134 = Control.Monad.Identity.runIdentity (attach_T_Range (arg_range_))
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         _oneLineTree = rule285 arg_value_
         _self = rule286 _rangeIself arg_value_
         _lhsOself :: Literal
         _lhsOself = rule287 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule288 _oneLineTree
   ...
   rule285 = \ value_ ->
                                            OneLineText value_
   {-# INLINE rule286 #-}
   rule286 = \ ((_rangeIself) :: Range) value_ ->
     Literal_Int _rangeIself value_
   {-# INLINE rule287 #-}
   rule287 = \ _self ->
     _self
   {-# INLINE rule288 #-}
   rule288 = \ _oneLineTree ->
     _oneLineTree
...
sem_Literal_Char arg_range_ !arg_value_ = T_Literal (return st86) where
   ...
   !st86 = let
      ...
      v85 = \ !(T_Literal_vIn85 ) -> ( let
         _rangeX134 = Control.Monad.Identity.runIdentity (attach_T_Range (arg_range_))
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         _oneLineTree = rule289 arg_value_
         _self = rule290 _rangeIself arg_value_
         _lhsOself :: Literal
         _lhsOself = rule291 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule292 _oneLineTree
         !__result_ = T_Literal_vOut85 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Literal_s86 v85
   {-# INLINE rule289 #-}
   rule289 = \ value_ ->
                                            OneLineText ("'" ++ value_ ++ "'")
   {-# INLINE rule290 #-}
   rule290 = \ ((_rangeIself) :: Range) value_ ->
     Literal_Char _rangeIself value_
   {-# INLINE rule291 #-}
   rule291 = \ _self ->
     _self
   {-# INLINE rule292 #-}
   rule292 = \ _oneLineTree ->
     _oneLineTree
...
sem_Literal_Float arg_range_ !arg_value_ = T_Literal (return st86) where
   ...
   !st86 = let
      ...
      v85 = \ !(T_Literal_vIn85 ) -> ( let
         _rangeX134 = Control.Monad.Identity.runIdentity (attach_T_Range (arg_range_))
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         _oneLineTree = rule293 arg_value_
         _self = rule294 _rangeIself arg_value_
         _lhsOself :: Literal
         _lhsOself = rule295 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule296 _oneLineTree
         !__result_ = T_Literal_vOut85 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Literal_s86 v85
   {-# INLINE rule293 #-}
   rule293 = \ value_ ->
                                            OneLineText value_
   {-# INLINE rule294 #-}
   rule294 = \ ((_rangeIself) :: Range) value_ ->
     Literal_Float _rangeIself value_
   {-# INLINE rule295 #-}
   rule295 = \ _self ->
     _self
   {-# INLINE rule296 #-}
   rule296 = \ _oneLineTree ->
     _oneLineTree
...
sem_Literal_String arg_range_ !arg_value_ = T_Literal (return st86) where
   ...
   !st86 = let
      ...
      v85 = \ !(T_Literal_vIn85 ) -> ( let
         _rangeX134 = Control.Monad.Identity.runIdentity (attach_T_Range (arg_range_))
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         _oneLineTree = rule297 arg_value_
         _self = rule298 _rangeIself arg_value_
         _lhsOself :: Literal
         _lhsOself = rule299 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule300 _oneLineTree
         !__result_ = T_Literal_vOut85 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Literal_s86 v85
   {-# INLINE rule297 #-}
   rule297 = \ value_ ->
                                            OneLineText ("\"" ++ value_ ++ "\"")
   {-# INLINE rule298 #-}
   rule298 = \ ((_rangeIself) :: Range) value_ ->
     Literal_String _rangeIself value_
   {-# INLINE rule299 #-}
   rule299 = \ _self ->
     _self
   {-# INLINE rule300 #-}
   rule300 = \ _oneLineTree ->
     _oneLineTree
...
wrap_MaybeDeclarations !(T_MaybeDeclarations act) !(Inh_MaybeDeclarations ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_MaybeDeclarations_vOut88 _lhsOoneLineTree _lhsOself) <- return (inv_MaybeDeclarations_s89 sem arg88)
...
sem_MaybeDeclarations_Just arg_declarations_ = T_MaybeDeclarations (return st89) where
   ...
   !st89 = let
      ...
      v88 = \ !(T_MaybeDeclarations_vIn88 ) -> ( let
         _declarationsX32 = Control.Monad.Identity.runIdentity (attach_T_Declarations (arg_declarations_))
         (T_Declarations_vOut31 _declarationsIoneLineTree _declarationsIself) = inv_Declarations_s32 _declarationsX32 (T_Declarations_vIn31 )
         _oneLineTree = rule305 _declarationsIoneLineTree
         _self = rule306 _declarationsIself
         _lhsOself :: MaybeDeclarations
         _lhsOself = rule307 _self
         _lhsOoneLineTree ::  Maybe [OneLineTree] 
         _lhsOoneLineTree = rule308 _oneLineTree
         !__result_ = T_MaybeDeclarations_vOut88 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_MaybeDeclarations_s89 v88
   {-# INLINE rule305 #-}
   rule305 = \ ((_declarationsIoneLineTree) ::  [ OneLineTree] ) ->
                                            Just _declarationsIoneLineTree
   {-# INLINE rule306 #-}
   rule306 = \ ((_declarationsIself) :: Declarations) ->
     MaybeDeclarations_Just _declarationsIself
   {-# INLINE rule307 #-}
   rule307 = \ _self ->
     _self
   {-# INLINE rule308 #-}
   rule308 = \ _oneLineTree ->
     _oneLineTree
...
wrap_MaybeExpression !(T_MaybeExpression act) !(Inh_MaybeExpression ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_MaybeExpression_vOut94 _lhsOoneLineTree _lhsOself) <- return (inv_MaybeExpression_s95 sem arg94)
...
sem_MaybeExpression_Nothing  = T_MaybeExpression (return st95) where
   ...
   !st95 = let
      ...
      v94 = \ !(T_MaybeExpression_vIn94 ) -> ( let
         _oneLineTree = rule313  ()
         _self = rule314  ()
         _lhsOself :: MaybeExpression
         _lhsOself = rule315 _self
         _lhsOoneLineTree ::  Maybe OneLineTree 
         _lhsOoneLineTree = rule316 _oneLineTree
...
sem_MaybeExpression_Just arg_expression_ = T_MaybeExpression (return st95) where
   ...
   !st95 = let
      ...
      v94 = \ !(T_MaybeExpression_vIn94 ) -> ( let
         _expressionX41 = Control.Monad.Identity.runIdentity (attach_T_Expression (arg_expression_))
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _oneLineTree = rule317 _expressionIoneLineTree
         _self = rule318 _expressionIself
         _lhsOself :: MaybeExpression
         _lhsOself = rule319 _self
         _lhsOoneLineTree ::  Maybe OneLineTree 
         _lhsOoneLineTree = rule320 _oneLineTree
         !__result_ = T_MaybeExpression_vOut94 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_MaybeExpression_s95 v94
   {-# INLINE rule317 #-}
   rule317 = \ ((_expressionIoneLineTree) :: OneLineTree) ->
                                            Just _expressionIoneLineTree
   {-# INLINE rule318 #-}
   rule318 = \ ((_expressionIself) :: Expression) ->
     MaybeExpression_Just _expressionIself
   {-# INLINE rule319 #-}
   rule319 = \ _self ->
     _self
   {-# INLINE rule320 #-}
   rule320 = \ _oneLineTree ->
     _oneLineTree
...
sem_MaybeImportSpecification_Just arg_importspecification_ = T_MaybeImportSpecification (return st98) where
   ...
   !st98 = let
      ...
      v97 = \ !(T_MaybeImportSpecification_vIn97 ) -> ( let
         ...
         _self = rule323 _importspecificationIself
         _lhsOself :: MaybeImportSpecification
     ...
     in C_MaybeImportSpecification_s98 v97
   {-# INLINE rule323 #-}
   rule323 = \ ((_importspecificationIself) :: ImportSpecification) ->
...
wrap_Module !(T_Module act) !(Inh_Module ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Module_vOut109 _lhsOself) <- return (inv_Module_s110 sem arg109)
...
sem_Module_Module arg_range_ arg_name_ arg_exports_ arg_body_ = T_Module (return st110) where
   ...
   !st110 = let
      ...
      v109 = \ !(T_Module_vIn109 ) -> ( let
         ...
         _self = rule337 _bodyIself _exportsIself _nameIself _rangeIself
         _lhsOself :: Module
   ...
   {-# INLINE rule337 #-}
   rule337 = \ ((_bodyIself) :: Body) ((_exportsIself) :: MaybeExports) ((_nameIself) :: MaybeName) ((_rangeIself) :: Range) ->
...
wrap_Name !(T_Name act) !(Inh_Name ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Name_vOut112 _lhsOisIdentifier _lhsOisOperator _lhsOisSpecial _lhsOoneLineTree _lhsOself) <- return (inv_Name_s113 sem arg112)
...
sem_Name_Identifier arg_range_ arg_module_ !arg_origin_ !arg_name_ = T_Name (return st113) where
   ...
   !st113 = let
      ...
      v112 = \ !(T_Name_vIn112 ) -> ( let
         ...
         _lhsOisIdentifier = rule339  ()
         _oneLineTree = rule340 arg_name_
         _lhsOisOperator :: Bool
         _lhsOisOperator = rule341  ()
         _lhsOisSpecial :: Bool
         _lhsOisSpecial = rule342  ()
         _self = rule343 _moduleIself _rangeIself arg_name_ arg_origin_
         _lhsOself :: Name
         _lhsOself = rule344 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule345 _oneLineTree
   ...
   rule342 = \  (_ :: ()) ->
     False
   {-# INLINE rule343 #-}
   rule343 = \ ((_moduleIself) :: Strings) ((_rangeIself) :: Range) name_ origin_ ->
     Name_Identifier _rangeIself _moduleIself origin_ name_
   {-# INLINE rule344 #-}
   rule344 = \ _self ->
     _self
   {-# INLINE rule345 #-}
   rule345 = \ _oneLineTree ->
     _oneLineTree
...
sem_Name_Operator arg_range_ arg_module_ !arg_origin_ !arg_name_ = T_Name (return st113) where
   ...
   !st113 = let
      ...
      v112 = \ !(T_Name_vIn112 ) -> ( let
         ...
         (T_Strings_vOut160 _moduleIoneLineTree _moduleIself) = inv_Strings_s161 _moduleX161 (T_Strings_vIn160 )
         _lhsOisOperator :: Bool
         _lhsOisOperator = rule346  ()
         _oneLineTree = rule347 arg_name_
         _lhsOisIdentifier :: Bool
         _lhsOisIdentifier = rule348  ()
         _lhsOisSpecial :: Bool
         _lhsOisSpecial = rule349  ()
         _self = rule350 _moduleIself _rangeIself arg_name_ arg_origin_
         _lhsOself :: Name
         _lhsOself = rule351 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule352 _oneLineTree
         !__result_ = T_Name_vOut112 _lhsOisIdentifier _lhsOisOperator _lhsOisSpecial _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Name_s113 v112
   {-# INLINE rule346 #-}
   ...
   rule349 = \  (_ :: ()) ->
     False
   {-# INLINE rule350 #-}
   rule350 = \ ((_moduleIself) :: Strings) ((_rangeIself) :: Range) name_ origin_ ->
     Name_Operator _rangeIself _moduleIself origin_ name_
   {-# INLINE rule351 #-}
   rule351 = \ _self ->
     _self
   {-# INLINE rule352 #-}
   rule352 = \ _oneLineTree ->
     _oneLineTree
...
sem_Name_Special arg_range_ arg_module_ !arg_origin_ !arg_name_ = T_Name (return st113) where
   ...
   !st113 = let
      ...
      v112 = \ !(T_Name_vIn112 ) -> ( let
         ...
         (T_Strings_vOut160 _moduleIoneLineTree _moduleIself) = inv_Strings_s161 _moduleX161 (T_Strings_vIn160 )
         _lhsOisSpecial :: Bool
         _lhsOisSpecial = rule353  ()
         _oneLineTree = rule354 arg_name_
         _lhsOisIdentifier :: Bool
         _lhsOisIdentifier = rule355  ()
         _lhsOisOperator :: Bool
         _lhsOisOperator = rule356  ()
         _self = rule357 _moduleIself _rangeIself arg_name_ arg_origin_
         _lhsOself :: Name
         _lhsOself = rule358 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule359 _oneLineTree
         !__result_ = T_Name_vOut112 _lhsOisIdentifier _lhsOisOperator _lhsOisSpecial _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Name_s113 v112
   {-# INLINE rule353 #-}
   ...
   rule356 = \  (_ :: ()) ->
     False
   {-# INLINE rule357 #-}
   rule357 = \ ((_moduleIself) :: Strings) ((_rangeIself) :: Range) name_ origin_ ->
     Name_Special _rangeIself _moduleIself origin_ name_
   {-# INLINE rule358 #-}
   rule358 = \ _self ->
     _self
   {-# INLINE rule359 #-}
   rule359 = \ _oneLineTree ->
     _oneLineTree
...
wrap_Names !(T_Names act) !(Inh_Names ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Names_vOut115 _lhsOisIdentifier _lhsOisOperator _lhsOisSpecial _lhsOoneLineTree _lhsOself) <- return (inv_Names_s116 sem arg115)
...
sem_Names_Cons arg_hd_ arg_tl_ = T_Names (return st116) where
   ...
   !st116 = let
      ...
      v115 = \ !(T_Names_vIn115 ) -> ( let
         ...
         _lhsOisIdentifier ::  [Bool] 
         _lhsOisIdentifier = rule360 _hdIisIdentifier _tlIisIdentifier
         _lhsOisOperator ::  [Bool] 
         _lhsOisOperator = rule361 _hdIisOperator _tlIisOperator
         _lhsOisSpecial ::  [Bool] 
         _lhsOisSpecial = rule362 _hdIisSpecial _tlIisSpecial
         _lhsOoneLineTree ::  [ OneLineTree] 
         _lhsOoneLineTree = rule363 _hdIoneLineTree _tlIoneLineTree
         _self = rule364 _hdIself _tlIself
         _lhsOself :: Names
   ...
   {-# INLINE rule360 #-}
   rule360 = \ ((_hdIisIdentifier) :: Bool) ((_tlIisIdentifier) ::  [Bool] ) ->
     _hdIisIdentifier  :  _tlIisIdentifier
   {-# INLINE rule361 #-}
   rule361 = \ ((_hdIisOperator) :: Bool) ((_tlIisOperator) ::  [Bool] ) ->
     _hdIisOperator  :  _tlIisOperator
   {-# INLINE rule362 #-}
   rule362 = \ ((_hdIisSpecial) :: Bool) ((_tlIisSpecial) ::  [Bool] ) ->
     _hdIisSpecial  :  _tlIisSpecial
   {-# INLINE rule363 #-}
   rule363 = \ ((_hdIoneLineTree) :: OneLineTree) ((_tlIoneLineTree) ::  [ OneLineTree] ) ->
     _hdIoneLineTree  :  _tlIoneLineTree
   {-# INLINE rule364 #-}
   rule364 = \ ((_hdIself) :: Name) ((_tlIself) :: Names) ->
     (:) _hdIself _tlIself
   {-# INLINE rule365 #-}
   rule365 = \ _self ->
     _self
...
sem_Names_Nil  = T_Names (return st116) where
   ...
   !st116 = let
      ...
      v115 = \ !(T_Names_vIn115 ) -> ( let
         _lhsOisIdentifier ::  [Bool] 
         _lhsOisIdentifier = rule366  ()
         _lhsOisOperator ::  [Bool] 
         _lhsOisOperator = rule367  ()
         _lhsOisSpecial ::  [Bool] 
         _lhsOisSpecial = rule368  ()
         _lhsOoneLineTree ::  [ OneLineTree] 
         _lhsOoneLineTree = rule369  ()
         _self = rule370  ()
         _lhsOself :: Names
...
wrap_Pattern !(T_Pattern act) !(Inh_Pattern ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Pattern_vOut118 _lhsOoneLineTree _lhsOself) <- return (inv_Pattern_s119 sem arg118)
...
sem_Pattern_Hole arg_range_ !arg_id_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         _rangeX134 = Control.Monad.Identity.runIdentity (attach_T_Range (arg_range_))
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         _oneLineTree = rule372  ()
         _self = rule373 _rangeIself arg_id_
         _lhsOself :: Pattern
         _lhsOself = rule374 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule375 _oneLineTree
   ...
   rule372 = \  (_ :: ()) ->
                                 OneLineText hole
   {-# INLINE rule373 #-}
   rule373 = \ ((_rangeIself) :: Range) id_ ->
     Pattern_Hole _rangeIself id_
   {-# INLINE rule374 #-}
   rule374 = \ _self ->
     _self
   {-# INLINE rule375 #-}
   rule375 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_Literal arg_range_ arg_literal_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Literal_vOut85 _literalIoneLineTree _literalIself) = inv_Literal_s86 _literalX86 (T_Literal_vIn85 )
         _oneLineTree = rule376 _literalIoneLineTree
         _self = rule377 _literalIself _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule378 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule379 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule376 #-}
   rule376 = \ ((_literalIoneLineTree) :: OneLineTree) ->
                                 _literalIoneLineTree
   {-# INLINE rule377 #-}
   rule377 = \ ((_literalIself) :: Literal) ((_rangeIself) :: Range) ->
     Pattern_Literal _rangeIself _literalIself
   {-# INLINE rule378 #-}
   rule378 = \ _self ->
     _self
   {-# INLINE rule379 #-}
   rule379 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_Variable arg_range_ arg_name_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _oneLineTree = rule380 _nameIoneLineTree
         _self = rule381 _nameIself _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule382 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule383 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule380 #-}
   rule380 = \ ((_nameIoneLineTree) :: OneLineTree) ->
                                 _nameIoneLineTree
   {-# INLINE rule381 #-}
   rule381 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
     Pattern_Variable _rangeIself _nameIself
   {-# INLINE rule382 #-}
   rule382 = \ _self ->
     _self
   {-# INLINE rule383 #-}
   rule383 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_Constructor arg_range_ arg_name_ arg_patterns_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_Patterns_vOut121 _patternsIoneLineTree _patternsIself) = inv_Patterns_s122 _patternsX122 (T_Patterns_vIn121 )
         _operatorName = rule384 _nameIisOperator _nameIoneLineTree
         _oneLineTree = rule385 _operatorName _patternsIoneLineTree
         _self = rule386 _nameIself _patternsIself _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule387 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule388 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule384 #-}
   rule384 = \ ((_nameIisOperator) :: Bool) ((_nameIoneLineTree) :: OneLineTree) ->
                                  if _nameIisOperator
                                    then OneLineNode [OneLineText "(", _nameIoneLineTree, OneLineText ")"]
                                    else _nameIoneLineTree
   {-# INLINE rule385 #-}
   rule385 = \ _operatorName ((_patternsIoneLineTree) ::  [ OneLineTree] ) ->
                                 OneLineNode (sepBy (OneLineText " ") (_operatorName : _patternsIoneLineTree))
   {-# INLINE rule386 #-}
   rule386 = \ ((_nameIself) :: Name) ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
     Pattern_Constructor _rangeIself _nameIself _patternsIself
   {-# INLINE rule387 #-}
   rule387 = \ _self ->
     _self
   {-# INLINE rule388 #-}
   rule388 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_Parenthesized arg_range_ arg_pattern_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Pattern_vOut118 _patternIoneLineTree _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         _oneLineTree = rule389 _patternIoneLineTree
         _self = rule390 _patternIself _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule391 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule392 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule389 #-}
   rule389 = \ ((_patternIoneLineTree) :: OneLineTree) ->
                                 parens _patternIoneLineTree
   {-# INLINE rule390 #-}
   rule390 = \ ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
     Pattern_Parenthesized _rangeIself _patternIself
   {-# INLINE rule391 #-}
   rule391 = \ _self ->
     _self
   {-# INLINE rule392 #-}
   rule392 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_InfixConstructor arg_range_ arg_leftPattern_ arg_constructorOperator_ arg_rightPattern_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Name_vOut112 _constructorOperatorIisIdentifier _constructorOperatorIisOperator _constructorOperatorIisSpecial _constructorOperatorIoneLineTree _constructorOperatorIself) = inv_Name_s113 _constructorOperatorX113 (T_Name_vIn112 )
         (T_Pattern_vOut118 _rightPatternIoneLineTree _rightPatternIself) = inv_Pattern_s119 _rightPatternX119 (T_Pattern_vIn118 )
         _operatorName = rule393 _constructorOperatorIself
         _oneLineTree = rule394 _leftPatternIoneLineTree _operatorName _rightPatternIoneLineTree
         _self = rule395 _constructorOperatorIself _leftPatternIself _rangeIself _rightPatternIself
         _lhsOself :: Pattern
         _lhsOself = rule396 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule397 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule393 #-}
   rule393 = \ ((_constructorOperatorIself) :: Name) ->
                                  OneLineText (showNameAsOperator _constructorOperatorIself)
   {-# INLINE rule394 #-}
   rule394 = \ ((_leftPatternIoneLineTree) :: OneLineTree) _operatorName ((_rightPatternIoneLineTree) :: OneLineTree) ->
                  OneLineNode
   ...
   {-# INLINE rule395 #-}
   rule395 = \ ((_constructorOperatorIself) :: Name) ((_leftPatternIself) :: Pattern) ((_rangeIself) :: Range) ((_rightPatternIself) :: Pattern) ->
     Pattern_InfixConstructor _rangeIself _leftPatternIself _constructorOperatorIself _rightPatternIself
   {-# INLINE rule396 #-}
   rule396 = \ _self ->
     _self
   {-# INLINE rule397 #-}
   rule397 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_List arg_range_ arg_patterns_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Patterns_vOut121 _patternsIoneLineTree _patternsIself) = inv_Patterns_s122 _patternsX122 (T_Patterns_vIn121 )
         _oneLineTree = rule398 _patternsIoneLineTree
         _self = rule399 _patternsIself _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule400 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule401 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule398 #-}
   rule398 = \ ((_patternsIoneLineTree) ::  [ OneLineTree] ) ->
                                            encloseSep "[" ", " "]" _patternsIoneLineTree
   {-# INLINE rule399 #-}
   rule399 = \ ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
     Pattern_List _rangeIself _patternsIself
   {-# INLINE rule400 #-}
   rule400 = \ _self ->
     _self
   {-# INLINE rule401 #-}
   rule401 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_Tuple arg_range_ arg_patterns_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Patterns_vOut121 _patternsIoneLineTree _patternsIself) = inv_Patterns_s122 _patternsX122 (T_Patterns_vIn121 )
         _oneLineTree = rule402 _patternsIoneLineTree
         _self = rule403 _patternsIself _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule404 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule405 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule402 #-}
   rule402 = \ ((_patternsIoneLineTree) ::  [ OneLineTree] ) ->
                                            encloseSep "(" ", " ")" _patternsIoneLineTree
   {-# INLINE rule403 #-}
   rule403 = \ ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
     Pattern_Tuple _rangeIself _patternsIself
   {-# INLINE rule404 #-}
   rule404 = \ _self ->
     _self
   {-# INLINE rule405 #-}
   rule405 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_Record arg_range_ arg_name_ arg_recordPatternBindings_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         _oneLineTree = rule406  ()
         _self = rule407 _nameIself _rangeIself _recordPatternBindingsIself
         _lhsOself :: Pattern
         _lhsOself = rule408 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule409 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule406 #-}
   ...
   {-# INLINE rule407 #-}
   rule407 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ((_recordPatternBindingsIself) :: RecordPatternBindings) ->
     Pattern_Record _rangeIself _nameIself _recordPatternBindingsIself
   {-# INLINE rule408 #-}
   rule408 = \ _self ->
     _self
   {-# INLINE rule409 #-}
   rule409 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_Negate arg_range_ arg_literal_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Literal_vOut85 _literalIoneLineTree _literalIself) = inv_Literal_s86 _literalX86 (T_Literal_vIn85 )
         _oneLineTree = rule410 _literalIoneLineTree
         _self = rule411 _literalIself _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule412 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule413 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule410 #-}
   rule410 = \ ((_literalIoneLineTree) :: OneLineTree) ->
                                            OneLineNode [ OneLineText "-", _literalIoneLineTree ]
   {-# INLINE rule411 #-}
   rule411 = \ ((_literalIself) :: Literal) ((_rangeIself) :: Range) ->
     Pattern_Negate _rangeIself _literalIself
   {-# INLINE rule412 #-}
   rule412 = \ _self ->
     _self
   {-# INLINE rule413 #-}
   rule413 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_As arg_range_ arg_name_ arg_pattern_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_Pattern_vOut118 _patternIoneLineTree _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         _oneLineTree = rule414 _nameIoneLineTree _patternIoneLineTree
         _self = rule415 _nameIself _patternIself _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule416 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule417 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule414 #-}
   rule414 = \ ((_nameIoneLineTree) :: OneLineTree) ((_patternIoneLineTree) :: OneLineTree) ->
                  OneLineNode
                      [ OneLineNode [_nameIoneLineTree]
                      , OneLineText "@"
                      , OneLineNode [_patternIoneLineTree]
   ...
   {-# INLINE rule415 #-}
   rule415 = \ ((_nameIself) :: Name) ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
     Pattern_As _rangeIself _nameIself _patternIself
   {-# INLINE rule416 #-}
   rule416 = \ _self ->
     _self
   {-# INLINE rule417 #-}
   rule417 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_Wildcard arg_range_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         _rangeX134 = Control.Monad.Identity.runIdentity (attach_T_Range (arg_range_))
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         _oneLineTree = rule418  ()
         _self = rule419 _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule420 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule421 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule418 #-}
   rule418 = \  (_ :: ()) ->
                                 OneLineText "_"
   {-# INLINE rule419 #-}
   rule419 = \ ((_rangeIself) :: Range) ->
     Pattern_Wildcard _rangeIself
   {-# INLINE rule420 #-}
   rule420 = \ _self ->
     _self
   {-# INLINE rule421 #-}
   rule421 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_Irrefutable arg_range_ arg_pattern_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Pattern_vOut118 _patternIoneLineTree _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         _oneLineTree = rule422  ()
         _self = rule423 _patternIself _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule424 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule425 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule422 #-}
   ...
   {-# INLINE rule423 #-}
   rule423 = \ ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
     Pattern_Irrefutable _rangeIself _patternIself
   {-# INLINE rule424 #-}
   rule424 = \ _self ->
     _self
   {-# INLINE rule425 #-}
   rule425 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_Successor arg_range_ arg_name_ arg_literal_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_Literal_vOut85 _literalIoneLineTree _literalIself) = inv_Literal_s86 _literalX86 (T_Literal_vIn85 )
         _oneLineTree = rule426  ()
         _self = rule427 _literalIself _nameIself _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule428 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule429 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule426 #-}
   ...
   {-# INLINE rule427 #-}
   rule427 = \ ((_literalIself) :: Literal) ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
     Pattern_Successor _rangeIself _nameIself _literalIself
   {-# INLINE rule428 #-}
   rule428 = \ _self ->
     _self
   {-# INLINE rule429 #-}
   rule429 = \ _oneLineTree ->
     _oneLineTree
...
sem_Pattern_NegateFloat arg_range_ arg_literal_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Literal_vOut85 _literalIoneLineTree _literalIself) = inv_Literal_s86 _literalX86 (T_Literal_vIn85 )
         _oneLineTree = rule430 _literalIoneLineTree
         _self = rule431 _literalIself _rangeIself
         _lhsOself :: Pattern
         _lhsOself = rule432 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule433 _oneLineTree
         !__result_ = T_Pattern_vOut118 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Pattern_s119 v118
   {-# INLINE rule430 #-}
   rule430 = \ ((_literalIoneLineTree) :: OneLineTree) ->
                                            OneLineNode [ OneLineText "-." , _literalIoneLineTree ]
   {-# INLINE rule431 #-}
   rule431 = \ ((_literalIself) :: Literal) ((_rangeIself) :: Range) ->
     Pattern_NegateFloat _rangeIself _literalIself
   {-# INLINE rule432 #-}
   rule432 = \ _self ->
     _self
   {-# INLINE rule433 #-}
   rule433 = \ _oneLineTree ->
     _oneLineTree
...
wrap_Patterns !(T_Patterns act) !(Inh_Patterns ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Patterns_vOut121 _lhsOoneLineTree _lhsOself) <- return (inv_Patterns_s122 sem arg121)
...
sem_Patterns_Cons arg_hd_ arg_tl_ = T_Patterns (return st122) where
   ...
   !st122 = let
      ...
      v121 = \ !(T_Patterns_vIn121 ) -> ( let
         ...
         _lhsOoneLineTree ::  [ OneLineTree] 
         _lhsOoneLineTree = rule434 _hdIoneLineTree _tlIoneLineTree
         _self = rule435 _hdIself _tlIself
         _lhsOself :: Patterns
   ...
   {-# INLINE rule434 #-}
   rule434 = \ ((_hdIoneLineTree) :: OneLineTree) ((_tlIoneLineTree) ::  [ OneLineTree] ) ->
     _hdIoneLineTree  :  _tlIoneLineTree
   {-# INLINE rule435 #-}
   rule435 = \ ((_hdIself) :: Pattern) ((_tlIself) :: Patterns) ->
     (:) _hdIself _tlIself
   {-# INLINE rule436 #-}
   rule436 = \ _self ->
     _self
...
sem_Position_Position !arg_filename_ !arg_line_ !arg_column_ = T_Position (return st125) where
   ...
   !st125 = let
      ...
      v124 = \ !(T_Position_vIn124 ) -> ( let
         _self = rule440 arg_column_ arg_filename_ arg_line_
         _lhsOself :: Position
   ...
   {-# INLINE rule440 #-}
   rule440 = \ column_ filename_ line_ ->
...
wrap_Qualifier !(T_Qualifier act) !(Inh_Qualifier ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Qualifier_vOut127 _lhsOoneLineTree _lhsOself) <- return (inv_Qualifier_s128 sem arg127)
...
sem_Qualifier_Guard arg_range_ arg_guard_ = T_Qualifier (return st128) where
   ...
   !st128 = let
      ...
      v127 = \ !(T_Qualifier_vIn127 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expression_vOut40 _guardIoneLineTree _guardIself) = inv_Expression_s41 _guardX41 (T_Expression_vIn40 )
         _oneLineTree = rule444 _guardIoneLineTree
         _self = rule445 _guardIself _rangeIself
         _lhsOself :: Qualifier
         _lhsOself = rule446 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule447 _oneLineTree
         !__result_ = T_Qualifier_vOut127 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Qualifier_s128 v127
   {-# INLINE rule444 #-}
   rule444 = \ ((_guardIoneLineTree) :: OneLineTree) ->
                                            _guardIoneLineTree
   {-# INLINE rule445 #-}
   rule445 = \ ((_guardIself) :: Expression) ((_rangeIself) :: Range) ->
     Qualifier_Guard _rangeIself _guardIself
   {-# INLINE rule446 #-}
   rule446 = \ _self ->
     _self
   {-# INLINE rule447 #-}
   rule447 = \ _oneLineTree ->
     _oneLineTree
...
sem_Qualifier_Let arg_range_ arg_declarations_ = T_Qualifier (return st128) where
   ...
   !st128 = let
      ...
      v127 = \ !(T_Qualifier_vIn127 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Declarations_vOut31 _declarationsIoneLineTree _declarationsIself) = inv_Declarations_s32 _declarationsX32 (T_Declarations_vIn31 )
         _oneLineTree = rule448 _declarationsIoneLineTree
         _self = rule449 _declarationsIself _rangeIself
         _lhsOself :: Qualifier
         _lhsOself = rule450 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule451 _oneLineTree
         !__result_ = T_Qualifier_vOut127 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Qualifier_s128 v127
   {-# INLINE rule448 #-}
   rule448 = \ ((_declarationsIoneLineTree) ::  [ OneLineTree] ) ->
              OneLineNode [ OneLineText "let ", encloseSep "{" "; " "}" _declarationsIoneLineTree ]
   {-# INLINE rule449 #-}
   rule449 = \ ((_declarationsIself) :: Declarations) ((_rangeIself) :: Range) ->
     Qualifier_Let _rangeIself _declarationsIself
   {-# INLINE rule450 #-}
   rule450 = \ _self ->
     _self
   {-# INLINE rule451 #-}
   rule451 = \ _oneLineTree ->
     _oneLineTree
...
sem_Qualifier_Generator arg_range_ arg_pattern_ arg_expression_ = T_Qualifier (return st128) where
   ...
   !st128 = let
      ...
      v127 = \ !(T_Qualifier_vIn127 ) -> ( let
         ...
         (T_Pattern_vOut118 _patternIoneLineTree _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _oneLineTree = rule452 _expressionIoneLineTree _patternIoneLineTree
         _self = rule453 _expressionIself _patternIself _rangeIself
         _lhsOself :: Qualifier
         _lhsOself = rule454 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule455 _oneLineTree
         !__result_ = T_Qualifier_vOut127 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Qualifier_s128 v127
   {-# INLINE rule452 #-}
   rule452 = \ ((_expressionIoneLineTree) :: OneLineTree) ((_patternIoneLineTree) :: OneLineTree) ->
              OneLineNode [ _patternIoneLineTree, OneLineText " <- ", _expressionIoneLineTree ]
   {-# INLINE rule453 #-}
   rule453 = \ ((_expressionIself) :: Expression) ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
     Qualifier_Generator _rangeIself _patternIself _expressionIself
   {-# INLINE rule454 #-}
   rule454 = \ _self ->
     _self
   {-# INLINE rule455 #-}
   rule455 = \ _oneLineTree ->
     _oneLineTree
...
sem_Qualifier_Empty arg_range_ = T_Qualifier (return st128) where
   ...
   !st128 = let
      ...
      v127 = \ !(T_Qualifier_vIn127 ) -> ( let
         _rangeX134 = Control.Monad.Identity.runIdentity (attach_T_Range (arg_range_))
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         _oneLineTree = rule456  ()
         _self = rule457 _rangeIself
         _lhsOself :: Qualifier
         _lhsOself = rule458 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule459 _oneLineTree
         !__result_ = T_Qualifier_vOut127 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Qualifier_s128 v127
   {-# INLINE rule456 #-}
...
wrap_Qualifiers !(T_Qualifiers act) !(Inh_Qualifiers ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Qualifiers_vOut130 _lhsOoneLineTree _lhsOself) <- return (inv_Qualifiers_s131 sem arg130)
...
sem_Qualifiers_Cons arg_hd_ arg_tl_ = T_Qualifiers (return st131) where
   ...
   !st131 = let
      ...
      v130 = \ !(T_Qualifiers_vIn130 ) -> ( let
         ...
         _lhsOoneLineTree ::  [ OneLineTree] 
         _lhsOoneLineTree = rule460 _hdIoneLineTree _tlIoneLineTree
         _self = rule461 _hdIself _tlIself
   ...
   {-# INLINE rule460 #-}
   rule460 = \ ((_hdIoneLineTree) :: OneLineTree) ((_tlIoneLineTree) ::  [ OneLineTree] ) ->
     _hdIoneLineTree  :  _tlIoneLineTree
   {-# INLINE rule461 #-}
   rule461 = \ ((_hdIself) :: Qualifier) ((_tlIself) :: Qualifiers) ->
     (:) _hdIself _tlIself
   {-# INLINE rule462 #-}
   rule462 = \ _self ->
     _self
...
sem_Range_Range arg_start_ arg_stop_ = T_Range (return st134) where
   ...
   !st134 = let
      ...
      v133 = \ !(T_Range_vIn133 ) -> ( let
         ...
         _self = rule466 _startIself _stopIself
         _lhsOself :: Range
   ...
   {-# INLINE rule466 #-}
   rule466 = \ ((_startIself) :: Position) ((_stopIself) :: Position) ->
...
sem_RecordExpressionBinding_RecordExpressionBinding arg_range_ arg_name_ arg_expression_ = T_RecordExpressionBinding (return st137) where
   ...
   !st137 = let
      ...
      v136 = \ !(T_RecordExpressionBinding_vIn136 ) -> ( let
         ...
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule468 _expressionIself _nameIself _rangeIself
   ...
   {-# INLINE rule468 #-}
   rule468 = \ ((_expressionIself) :: Expression) ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
...
sem_RecordExpressionBindings_Cons arg_hd_ arg_tl_ = T_RecordExpressionBindings (return st140) where
   ...
   !st140 = let
      ...
      v139 = \ !(T_RecordExpressionBindings_vIn139 ) -> ( let
         ...
         _self = rule470 _hdIself _tlIself
         _lhsOself :: RecordExpressionBindings
         _lhsOself = rule471 _self
         !__result_ = T_RecordExpressionBindings_vOut139 _lhsOself
         in __result_ )
     in C_RecordExpressionBindings_s140 v139
   {-# INLINE rule470 #-}
   rule470 = \ ((_hdIself) :: RecordExpressionBinding) ((_tlIself) :: RecordExpressionBindings) ->
     (:) _hdIself _tlIself
   {-# INLINE rule471 #-}
   rule471 = \ _self ->
     _self
...
sem_RecordPatternBinding_RecordPatternBinding arg_range_ arg_name_ arg_pattern_ = T_RecordPatternBinding (return st143) where
   ...
   !st143 = let
      ...
      v142 = \ !(T_RecordPatternBinding_vIn142 ) -> ( let
         ...
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_Pattern_vOut118 _patternIoneLineTree _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         _self = rule474 _nameIself _patternIself _rangeIself
   ...
   {-# INLINE rule474 #-}
   rule474 = \ ((_nameIself) :: Name) ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
...
sem_RecordPatternBindings_Cons arg_hd_ arg_tl_ = T_RecordPatternBindings (return st146) where
   ...
   !st146 = let
      ...
      v145 = \ !(T_RecordPatternBindings_vIn145 ) -> ( let
         ...
         _self = rule476 _hdIself _tlIself
   ...
   {-# INLINE rule476 #-}
   rule476 = \ ((_hdIself) :: RecordPatternBinding) ((_tlIself) :: RecordPatternBindings) ->
     (:) _hdIself _tlIself
   {-# INLINE rule477 #-}
   rule477 = \ _self ->
     _self
...
wrap_RightHandSide !(T_RightHandSide act) !(Inh_RightHandSide ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_RightHandSide_vOut148 _lhsOoneLineTree _lhsOself) <- return (inv_RightHandSide_s149 sem arg148)
...
sem_RightHandSide_Expression arg_range_ arg_expression_ arg_where_ = T_RightHandSide (return st149) where
   ...
   !st149 = let
      ...
      v148 = \ !(T_RightHandSide_vIn148 ) -> ( let
         ...
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         (T_MaybeDeclarations_vOut88 _whereIoneLineTree _whereIself) = inv_MaybeDeclarations_s89 _whereX89 (T_MaybeDeclarations_vIn88 )
         _oneLineTree = rule480 _expressionIoneLineTree _whereIoneLineTree
         _self = rule481 _expressionIself _rangeIself _whereIself
         _lhsOself :: RightHandSide
         _lhsOself = rule482 _self
         _lhsOoneLineTree ::  String -> OneLineTree 
         _lhsOoneLineTree = rule483 _oneLineTree
         !__result_ = T_RightHandSide_vOut148 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_RightHandSide_s149 v148
   {-# INLINE rule480 #-}
   rule480 = \ ((_expressionIoneLineTree) :: OneLineTree) ((_whereIoneLineTree) ::  Maybe [OneLineTree] ) ->
              \assign -> OneLineNode
   ...
   {-# INLINE rule481 #-}
   rule481 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ((_whereIself) :: MaybeDeclarations) ->
     RightHandSide_Expression _rangeIself _expressionIself _whereIself
   {-# INLINE rule482 #-}
   rule482 = \ _self ->
     _self
   {-# INLINE rule483 #-}
   rule483 = \ _oneLineTree ->
     _oneLineTree
...
sem_RightHandSide_Guarded arg_range_ arg_guardedexpressions_ arg_where_ = T_RightHandSide (return st149) where
   ...
   !st149 = let
      ...
      v148 = \ !(T_RightHandSide_vIn148 ) -> ( let
         ...
         (T_MaybeDeclarations_vOut88 _whereIoneLineTree _whereIself) = inv_MaybeDeclarations_s89 _whereX89 (T_MaybeDeclarations_vIn88 )
         _oneLineTree = rule484 _guardedexpressionsIoneLineTree _whereIoneLineTree
         _self = rule485 _guardedexpressionsIself _rangeIself _whereIself
         _lhsOself :: RightHandSide
         _lhsOself = rule486 _self
         _lhsOoneLineTree ::  String -> OneLineTree 
         _lhsOoneLineTree = rule487 _oneLineTree
         !__result_ = T_RightHandSide_vOut148 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_RightHandSide_s149 v148
   {-# INLINE rule484 #-}
   rule484 = \ ((_guardedexpressionsIoneLineTree) ::  [ String -> OneLineTree ] ) ((_whereIoneLineTree) ::  Maybe [OneLineTree] ) ->
              \assign -> OneLineNode
   ...
   {-# INLINE rule485 #-}
   rule485 = \ ((_guardedexpressionsIself) :: GuardedExpressions) ((_rangeIself) :: Range) ((_whereIself) :: MaybeDeclarations) ->
     RightHandSide_Guarded _rangeIself _guardedexpressionsIself _whereIself
   {-# INLINE rule486 #-}
   rule486 = \ _self ->
     _self
   {-# INLINE rule487 #-}
   rule487 = \ _oneLineTree ->
     _oneLineTree
...
sem_SimpleType_SimpleType arg_range_ arg_name_ arg_typevariables_ = T_SimpleType (return st152) where
   ...
   !st152 = let
      ...
      v151 = \ !(T_SimpleType_vIn151 ) -> ( let
         ...
         _self = rule488 _nameIself _rangeIself _typevariablesIself
   ...
   {-# INLINE rule488 #-}
   rule488 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ((_typevariablesIself) :: Names) ->
...
wrap_Statement !(T_Statement act) !(Inh_Statement ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Statement_vOut154 _lhsOoneLineTree _lhsOself) <- return (inv_Statement_s155 sem arg154)
...
sem_Statement_Expression arg_range_ arg_expression_ = T_Statement (return st155) where
   ...
   !st155 = let
      ...
      v154 = \ !(T_Statement_vIn154 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _oneLineTree = rule490 _expressionIoneLineTree
         _self = rule491 _expressionIself _rangeIself
         _lhsOself :: Statement
         _lhsOself = rule492 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule493 _oneLineTree
         !__result_ = T_Statement_vOut154 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Statement_s155 v154
   {-# INLINE rule490 #-}
   rule490 = \ ((_expressionIoneLineTree) :: OneLineTree) ->
                                            _expressionIoneLineTree
   {-# INLINE rule491 #-}
   rule491 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ->
     Statement_Expression _rangeIself _expressionIself
   {-# INLINE rule492 #-}
   rule492 = \ _self ->
     _self
   {-# INLINE rule493 #-}
   rule493 = \ _oneLineTree ->
     _oneLineTree
...
sem_Statement_Let arg_range_ arg_declarations_ = T_Statement (return st155) where
   ...
   !st155 = let
      ...
      v154 = \ !(T_Statement_vIn154 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Declarations_vOut31 _declarationsIoneLineTree _declarationsIself) = inv_Declarations_s32 _declarationsX32 (T_Declarations_vIn31 )
         _oneLineTree = rule494 _declarationsIoneLineTree
         _self = rule495 _declarationsIself _rangeIself
         _lhsOself :: Statement
         _lhsOself = rule496 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule497 _oneLineTree
         !__result_ = T_Statement_vOut154 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Statement_s155 v154
   {-# INLINE rule494 #-}
   rule494 = \ ((_declarationsIoneLineTree) ::  [ OneLineTree] ) ->
              OneLineNode [ OneLineText "let ", encloseSep "{" "; " "}" _declarationsIoneLineTree ]
   {-# INLINE rule495 #-}
   rule495 = \ ((_declarationsIself) :: Declarations) ((_rangeIself) :: Range) ->
     Statement_Let _rangeIself _declarationsIself
   {-# INLINE rule496 #-}
   rule496 = \ _self ->
     _self
   {-# INLINE rule497 #-}
   rule497 = \ _oneLineTree ->
     _oneLineTree
...
sem_Statement_Generator arg_range_ arg_pattern_ arg_expression_ = T_Statement (return st155) where
   ...
   !st155 = let
      ...
      v154 = \ !(T_Statement_vIn154 ) -> ( let
         ...
         (T_Pattern_vOut118 _patternIoneLineTree _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         (T_Expression_vOut40 _expressionIoneLineTree _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _oneLineTree = rule498 _expressionIoneLineTree _patternIoneLineTree
         _self = rule499 _expressionIself _patternIself _rangeIself
         _lhsOself :: Statement
         _lhsOself = rule500 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule501 _oneLineTree
         !__result_ = T_Statement_vOut154 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Statement_s155 v154
   {-# INLINE rule498 #-}
   rule498 = \ ((_expressionIoneLineTree) :: OneLineTree) ((_patternIoneLineTree) :: OneLineTree) ->
              OneLineNode [ _patternIoneLineTree, OneLineText " <- ", _expressionIoneLineTree ]
   {-# INLINE rule499 #-}
   rule499 = \ ((_expressionIself) :: Expression) ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
     Statement_Generator _rangeIself _patternIself _expressionIself
   {-# INLINE rule500 #-}
   rule500 = \ _self ->
     _self
   {-# INLINE rule501 #-}
   rule501 = \ _oneLineTree ->
     _oneLineTree
...
sem_Statement_Empty arg_range_ = T_Statement (return st155) where
   ...
   !st155 = let
      ...
      v154 = \ !(T_Statement_vIn154 ) -> ( let
         _rangeX134 = Control.Monad.Identity.runIdentity (attach_T_Range (arg_range_))
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         _oneLineTree = rule502  ()
         _self = rule503 _rangeIself
         _lhsOself :: Statement
         _lhsOself = rule504 _self
         _lhsOoneLineTree :: OneLineTree
         _lhsOoneLineTree = rule505 _oneLineTree
         !__result_ = T_Statement_vOut154 _lhsOoneLineTree _lhsOself
         in __result_ )
     in C_Statement_s155 v154
   {-# INLINE rule502 #-}
   rule502 = \  (_ :: ()) ->
                                            OneLineText ""
   {-# INLINE rule503 #-}
   rule503 = \ ((_rangeIself) :: Range) ->
     Statement_Empty _rangeIself
   {-# INLINE rule504 #-}
   rule504 = \ _self ->
     _self
   {-# INLINE rule505 #-}
   rule505 = \ _oneLineTree ->
     _oneLineTree
...
wrap_Statements !(T_Statements act) !(Inh_Statements ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Statements_vOut157 _lhsOoneLineTree _lhsOself) <- return (inv_Statements_s158 sem arg157)
...
sem_Statements_Cons arg_hd_ arg_tl_ = T_Statements (return st158) where
   ...
   !st158 = let
      ...
      v157 = \ !(T_Statements_vIn157 ) -> ( let
         ...
         _lhsOoneLineTree ::  [ OneLineTree] 
         _lhsOoneLineTree = rule506 _hdIoneLineTree _tlIoneLineTree
         _self = rule507 _hdIself _tlIself
   ...
   {-# INLINE rule506 #-}
   rule506 = \ ((_hdIoneLineTree) :: OneLineTree) ((_tlIoneLineTree) ::  [ OneLineTree] ) ->
     _hdIoneLineTree  :  _tlIoneLineTree
   {-# INLINE rule507 #-}
   rule507 = \ ((_hdIself) :: Statement) ((_tlIself) :: Statements) ->
     (:) _hdIself _tlIself
   {-# INLINE rule508 #-}
   rule508 = \ _self ->
     _self
...
wrap_Strings !(T_Strings act) !(Inh_Strings ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Strings_vOut160 _lhsOoneLineTree _lhsOself) <- return (inv_Strings_s161 sem arg160)
...
sem_Strings_Cons !arg_hd_ arg_tl_ = T_Strings (return st161) where
   ...
   !st161 = let
      ...
      v160 = \ !(T_Strings_vIn160 ) -> ( let
         ...
         _lhsOoneLineTree ::  [ OneLineTree] 
         _lhsOoneLineTree = rule512 _tlIoneLineTree
         _self = rule513 _tlIself arg_hd_
         _lhsOself :: Strings
   ...
   {-# INLINE rule512 #-}
   rule512 = \ ((_tlIoneLineTree) ::  [ OneLineTree] ) ->
     _tlIoneLineTree
   {-# INLINE rule513 #-}
   rule513 = \ ((_tlIself) :: Strings) hd_ ->
     (:) hd_ _tlIself
   {-# INLINE rule514 #-}
   rule514 = \ _self ->
     _self
...
sem_Type_Application arg_range_ !arg_prefix_ arg_function_ arg_arguments_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         _self = rule518 _argumentsIself _functionIself _rangeIself arg_prefix_
         _lhsOself :: Type
     ...
     in C_Type_s164 v163
   {-# INLINE rule518 #-}
   rule518 = \ ((_argumentsIself) :: Types) ((_functionIself) :: Type) ((_rangeIself) :: Range) prefix_ ->
...
sem_Type_Variable arg_range_ arg_name_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _self = rule520 _nameIself _rangeIself
         _lhsOself :: Type
     ...
     in C_Type_s164 v163
   {-# INLINE rule520 #-}
   rule520 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
...
sem_Type_Constructor arg_range_ arg_name_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Name_vOut112 _nameIisIdentifier _nameIisOperator _nameIisSpecial _nameIoneLineTree _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _self = rule522 _nameIself _rangeIself
         _lhsOself :: Type
         _lhsOself = rule523 _self
         !__result_ = T_Type_vOut163 _lhsOself
         in __result_ )
     in C_Type_s164 v163
   {-# INLINE rule522 #-}
   rule522 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
...
sem_Type_Qualified arg_range_ arg_context_ arg_type_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         (T_ContextItems_vOut25 _contextIself) = inv_ContextItems_s26 _contextX26 (T_ContextItems_vIn25 )
         (T_Type_vOut163 _typeIself) = inv_Type_s164 _typeX164 (T_Type_vIn163 )
         _self = rule524 _contextIself _rangeIself _typeIself
         _lhsOself :: Type
     ...
     in C_Type_s164 v163
   {-# INLINE rule524 #-}
   rule524 = \ ((_contextIself) :: ContextItems) ((_rangeIself) :: Range) ((_typeIself) :: Type) ->
...
sem_Type_Forall arg_range_ arg_typevariables_ arg_type_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         (T_Names_vOut115 _typevariablesIisIdentifier _typevariablesIisOperator _typevariablesIisSpecial _typevariablesIoneLineTree _typevariablesIself) = inv_Names_s116 _typevariablesX116 (T_Names_vIn115 )
         (T_Type_vOut163 _typeIself) = inv_Type_s164 _typeX164 (T_Type_vIn163 )
         _self = rule526 _rangeIself _typeIself _typevariablesIself
         _lhsOself :: Type
     ...
     in C_Type_s164 v163
   {-# INLINE rule526 #-}
   rule526 = \ ((_rangeIself) :: Range) ((_typeIself) :: Type) ((_typevariablesIself) :: Names) ->
...
sem_Type_Exists arg_range_ arg_typevariables_ arg_type_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         (T_Names_vOut115 _typevariablesIisIdentifier _typevariablesIisOperator _typevariablesIisSpecial _typevariablesIoneLineTree _typevariablesIself) = inv_Names_s116 _typevariablesX116 (T_Names_vIn115 )
         (T_Type_vOut163 _typeIself) = inv_Type_s164 _typeX164 (T_Type_vIn163 )
         _self = rule528 _rangeIself _typeIself _typevariablesIself
         _lhsOself :: Type
     ...
     in C_Type_s164 v163
   {-# INLINE rule528 #-}
   rule528 = \ ((_rangeIself) :: Range) ((_typeIself) :: Type) ((_typevariablesIself) :: Names) ->
...
sem_Type_Parenthesized arg_range_ arg_type_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Type_vOut163 _typeIself) = inv_Type_s164 _typeX164 (T_Type_vIn163 )
         _self = rule530 _rangeIself _typeIself
         _lhsOself :: Type
     ...
     in C_Type_s164 v163
   {-# INLINE rule530 #-}
   rule530 = \ ((_rangeIself) :: Range) ((_typeIself) :: Type) ->
...
sem_Types_Cons arg_hd_ arg_tl_ = T_Types (return st167) where
   ...
   !st167 = let
      ...
      v166 = \ !(T_Types_vIn166 ) -> ( let
         ...
         _self = rule532 _hdIself _tlIself
         _lhsOself :: Types
   ...
   {-# INLINE rule532 #-}
   rule532 = \ ((_hdIself) :: Type) ((_tlIself) :: Types) ->
     (:) _hdIself _tlIself
   {-# INLINE rule533 #-}
   rule533 = \ _self ->
     _self
