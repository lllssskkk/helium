...
data Syn_Body  = Syn_Body { coreImportDecls_Syn_Body :: !( [ImportList] ), self_Syn_Body :: !(Body) }
{-# INLINABLE wrap_Body #-}
...
data T_Body_vOut13  = T_Body_vOut13 ( [ImportList] ) (Body)
...
sem_Body_Hole arg_range_ !arg_id_ = T_Body (return st14) where
   ...
   !st14 = let
      ...
      v13 = \ !(T_Body_vIn13 ) -> ( let
         _rangeX134 = Control.Monad.Identity.runIdentity (attach_T_Range (arg_range_))
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         _lhsOcoreImportDecls ::  [ImportList] 
...
sem_Body_Body arg_range_ arg_importdeclarations_ arg_declarations_ = T_Body (return st14) where
   ...
   !st14 = let
     ...
     in C_Body_s14 v13
   {-# INLINE rule21 #-}
   rule21 = \ ((_importdeclarationsIcoreImportDecls) ::  [ImportList] ) ->
...
sem_Expression_Eta arg_range_ !arg_expansion_ arg_expression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule86 _expressionIself _rangeIself arg_expansion_
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule86 #-}
   rule86 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) expansion_ ->
...
sem_Expression_Constructor arg_range_ arg_name_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Name_vOut112 _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _self = rule92 _nameIself _rangeIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule92 #-}
   rule92 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
...
sem_Expression_Parenthesized arg_range_ arg_expression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule94 _expressionIself _rangeIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule94 #-}
   rule94 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ->
...
sem_Expression_NormalApplication arg_range_ arg_function_ arg_arguments_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _self = rule96 _argumentsIself _functionIself _rangeIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule96 #-}
   rule96 = \ ((_argumentsIself) :: Expressions) ((_functionIself) :: Expression) ((_rangeIself) :: Range) ->
...
sem_Expression_InfixApplication arg_range_ arg_leftExpression_ arg_operator_ arg_rightExpression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _self = rule98 _leftExpressionIself _operatorIself _rangeIself _rightExpressionIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule98 #-}
   rule98 = \ ((_leftExpressionIself) :: MaybeExpression) ((_operatorIself) :: Expression) ((_rangeIself) :: Range) ((_rightExpressionIself) :: MaybeExpression) ->
...
sem_Expression_If arg_range_ arg_guardExpression_ arg_thenExpression_ arg_elseExpression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _self = rule100 _elseExpressionIself _guardExpressionIself _rangeIself _thenExpressionIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule100 #-}
   rule100 = \ ((_elseExpressionIself) :: Expression) ((_guardExpressionIself) :: Expression) ((_rangeIself) :: Range) ((_thenExpressionIself) :: Expression) ->
...
sem_Expression_Lambda arg_range_ arg_patterns_ arg_expression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule102 _expressionIself _patternsIself _rangeIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule102 #-}
   rule102 = \ ((_expressionIself) :: Expression) ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
...
sem_Expression_Case arg_range_ arg_expression_ arg_alternatives_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _self = rule104 _alternativesIself _expressionIself _rangeIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule104 #-}
   rule104 = \ ((_alternativesIself) :: Alternatives) ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ->
...
sem_Expression_Let arg_range_ arg_declarations_ arg_expression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Declarations_vOut31 _declarationsIself) = inv_Declarations_s32 _declarationsX32 (T_Declarations_vIn31 )
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule106 _declarationsIself _expressionIself _rangeIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule106 #-}
   rule106 = \ ((_declarationsIself) :: Declarations) ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ->
...
sem_Expression_Do arg_range_ arg_statements_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _self = rule108 _rangeIself _statementsIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule108 #-}
   rule108 = \ ((_rangeIself) :: Range) ((_statementsIself) :: Statements) ->
...
sem_Expression_Tuple arg_range_ arg_expressions_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expressions_vOut43 _expressionsIself) = inv_Expressions_s44 _expressionsX44 (T_Expressions_vIn43 )
         _self = rule112 _expressionsIself _rangeIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule112 #-}
   rule112 = \ ((_expressionsIself) :: Expressions) ((_rangeIself) :: Range) ->
...
sem_Expression_Comprehension arg_range_ arg_expression_ arg_qualifiers_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _self = rule114 _expressionIself _qualifiersIself _rangeIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule114 #-}
   rule114 = \ ((_expressionIself) :: Expression) ((_qualifiersIself) :: Qualifiers) ((_rangeIself) :: Range) ->
...
sem_Expression_Typed arg_range_ arg_expression_ arg_type_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         (T_Type_vOut163 _typeIself) = inv_Type_s164 _typeX164 (T_Type_vIn163 )
         _self = rule116 _expressionIself _rangeIself _typeIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule116 #-}
   rule116 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ((_typeIself) :: Type) ->
...
sem_Expression_RecordConstruction arg_range_ arg_name_ arg_recordExpressionBindings_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _self = rule118 _nameIself _rangeIself _recordExpressionBindingsIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule118 #-}
   rule118 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ((_recordExpressionBindingsIself) :: RecordExpressionBindings) ->
...
sem_Expression_RecordUpdate arg_range_ arg_expression_ arg_recordExpressionBindings_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         (T_RecordExpressionBindings_vOut139 _recordExpressionBindingsIself) = inv_RecordExpressionBindings_s140 _recordExpressionBindingsX140 (T_RecordExpressionBindings_vIn139 )
         _self = rule120 _expressionIself _rangeIself _recordExpressionBindingsIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule120 #-}
   rule120 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ((_recordExpressionBindingsIself) :: RecordExpressionBindings) ->
...
sem_Expression_Enum arg_range_ arg_from_ arg_then_ arg_to_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         _self = rule122 _fromIself _rangeIself _thenIself _toIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule122 #-}
   rule122 = \ ((_fromIself) :: Expression) ((_rangeIself) :: Range) ((_thenIself) :: MaybeExpression) ((_toIself) :: MaybeExpression) ->
...
sem_Expression_NegateFloat arg_range_ arg_expression_ = T_Expression (return st41) where
   ...
   !st41 = let
      ...
      v40 = \ !(T_Expression_vIn40 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule126 _expressionIself _rangeIself
         _lhsOself :: Expression
     ...
     in C_Expression_s41 v40
   {-# INLINE rule126 #-}
   rule126 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ->
...
sem_Expressions_Cons arg_hd_ arg_tl_ = T_Expressions (return st44) where
   ...
   !st44 = let
      ...
      v43 = \ !(T_Expressions_vIn43 ) -> ( let
         ...
         _self = rule128 _hdIself _tlIself
   ...
   {-# INLINE rule128 #-}
   rule128 = \ ((_hdIself) :: Expression) ((_tlIself) :: Expressions) ->
     (:) _hdIself _tlIself
   {-# INLINE rule129 #-}
   rule129 = \ _self ->
     _self
...
sem_FieldDeclaration_FieldDeclaration arg_range_ arg_names_ arg_type_ = T_FieldDeclaration (return st47) where
   ...
   !st47 = let
      ...
      v46 = \ !(T_FieldDeclaration_vIn46 ) -> ( let
         ...
         _self = rule132 _namesIself _rangeIself _typeIself
   ...
   {-# INLINE rule132 #-}
   rule132 = \ ((_namesIself) :: Names) ((_rangeIself) :: Range) ((_typeIself) :: AnnotatedType) ->
...
sem_FieldDeclarations_Cons arg_hd_ arg_tl_ = T_FieldDeclarations (return st50) where
   ...
   !st50 = let
      ...
      v49 = \ !(T_FieldDeclarations_vIn49 ) -> ( let
         ...
         _self = rule134 _hdIself _tlIself
   ...
   {-# INLINE rule134 #-}
   rule134 = \ ((_hdIself) :: FieldDeclaration) ((_tlIself) :: FieldDeclarations) ->
     (:) _hdIself _tlIself
   {-# INLINE rule135 #-}
   rule135 = \ _self ->
     _self
...
sem_FunctionBinding_Hole arg_range_ !arg_id_ = T_FunctionBinding (return st56) where
   ...
   !st56 = let
      ...
      v55 = \ !(T_FunctionBinding_vIn55 ) -> ( let
         ...
         _lhsOname :: Name
         _lhsOname = rule144  ()
         _self = rule145 _rangeIself arg_id_
...
sem_FunctionBinding_Feedback arg_range_ !arg_feedback_ arg_functionBinding_ = T_FunctionBinding (return st56) where
   ...
   !st56 = let
      ...
      v55 = \ !(T_FunctionBinding_vIn55 ) -> ( let
         ...
         _self = rule147 _functionBindingIself _rangeIself arg_feedback_
         _lhsOself :: FunctionBinding
         _lhsOself = rule148 _self
         _lhsOname :: Name
         _lhsOname = rule149 _functionBindingIname
         !__result_ = T_FunctionBinding_vOut55 _lhsOname _lhsOself
         in __result_ )
     in C_FunctionBinding_s56 v55
   {-# INLINE rule147 #-}
   rule147 = \ ((_functionBindingIself) :: FunctionBinding) ((_rangeIself) :: Range) feedback_ ->
     FunctionBinding_Feedback _rangeIself feedback_ _functionBindingIself
   {-# INLINE rule148 #-}
   rule148 = \ _self ->
     _self
   {-# INLINE rule149 #-}
   rule149 = \ ((_functionBindingIname) :: Name) ->
...
sem_FunctionBinding_FunctionBinding arg_range_ arg_lefthandside_ arg_righthandside_ = T_FunctionBinding (return st56) where
   ...
   !st56 = let
      ...
      v55 = \ !(T_FunctionBinding_vIn55 ) -> ( let
         ...
         (T_RightHandSide_vOut148 _righthandsideIself) = inv_RightHandSide_s149 _righthandsideX149 (T_RightHandSide_vIn148 )
         _self = rule150 _lefthandsideIself _rangeIself _righthandsideIself
         _lhsOself :: FunctionBinding
         _lhsOself = rule151 _self
         _lhsOname :: Name
         _lhsOname = rule152 _lefthandsideIname
         !__result_ = T_FunctionBinding_vOut55 _lhsOname _lhsOself
         in __result_ )
     in C_FunctionBinding_s56 v55
   {-# INLINE rule150 #-}
   rule150 = \ ((_lefthandsideIself) :: LeftHandSide) ((_rangeIself) :: Range) ((_righthandsideIself) :: RightHandSide) ->
     FunctionBinding_FunctionBinding _rangeIself _lefthandsideIself _righthandsideIself
   {-# INLINE rule151 #-}
   rule151 = \ _self ->
     _self
   {-# INLINE rule152 #-}
   rule152 = \ ((_lefthandsideIname) :: Name) ->
     _lefthandsideIname
...
sem_FunctionBindings_Cons arg_hd_ arg_tl_ = T_FunctionBindings (return st59) where
   ...
   !st59 = let
      ...
      v58 = \ !(T_FunctionBindings_vIn58 ) -> ( let
         ...
         _lhsOname :: Name
         _lhsOname = rule153 _hdIname
         _self = rule154 _hdIself _tlIself
   ...
   {-# INLINE rule153 #-}
   rule153 = \ ((_hdIname) :: Name) ->
                         _hdIname
   {-# INLINE rule154 #-}
   rule154 = \ ((_hdIself) :: FunctionBinding) ((_tlIself) :: FunctionBindings) ->
     (:) _hdIself _tlIself
   {-# INLINE rule155 #-}
   rule155 = \ _self ->
     _self
...
sem_GuardedExpression_GuardedExpression arg_range_ arg_guard_ arg_expression_ = T_GuardedExpression (return st62) where
   ...
   !st62 = let
      ...
      v61 = \ !(T_GuardedExpression_vIn61 ) -> ( let
         ...
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule159 _expressionIself _guardIself _rangeIself
   ...
   {-# INLINE rule159 #-}
   rule159 = \ ((_expressionIself) :: Expression) ((_guardIself) :: Expression) ((_rangeIself) :: Range) ->
...
sem_GuardedExpressions_Cons arg_hd_ arg_tl_ = T_GuardedExpressions (return st65) where
   ...
   !st65 = let
      ...
      v64 = \ !(T_GuardedExpressions_vIn64 ) -> ( let
         ...
         _self = rule161 _hdIself _tlIself
   ...
   {-# INLINE rule161 #-}
   rule161 = \ ((_hdIself) :: GuardedExpression) ((_tlIself) :: GuardedExpressions) ->
     (:) _hdIself _tlIself
   {-# INLINE rule162 #-}
   rule162 = \ _self ->
     _self
...
data Syn_Import  = Syn_Import { confieldormethods_Syn_Import :: !(IdSet), self_Syn_Import :: !(Import), typeorclasses_Syn_Import :: !(IdSet), typeorclassesCompl_Syn_Import :: !(IdSet), values_Syn_Import :: !(IdSet) }
...
wrap_Import !(T_Import act) !(Inh_Import ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Import_vOut67 _lhsOconfieldormethods _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues) <- return (inv_Import_s68 sem arg67)
        return (Syn_Import _lhsOconfieldormethods _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues)
   )
...
data T_Import_vOut67  = T_Import_vOut67 (IdSet) (Import) (IdSet) (IdSet) (IdSet)
...
sem_Import_Variable arg_range_ arg_name_ = T_Import (return st68) where
   ...
   !st68 = let
      ...
      v67 = \ !(T_Import_vIn67 ) -> ( let
         ...
         (T_Name_vOut112 _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _lhsOvalues :: IdSet
         _lhsOvalues = rule165 _nameIself
         _lhsOconfieldormethods :: IdSet
         _lhsOconfieldormethods = rule166  ()
         _lhsOtypeorclasses :: IdSet
         _lhsOtypeorclasses = rule167  ()
         _lhsOtypeorclassesCompl :: IdSet
         _lhsOtypeorclassesCompl = rule168  ()
         _self = rule169 _nameIself _rangeIself
         _lhsOself :: Import
         _lhsOself = rule170 _self
         !__result_ = T_Import_vOut67 _lhsOconfieldormethods _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues
         in __result_ )
     in C_Import_s68 v67
   {-# INLINE rule165 #-}
   rule165 = \ ((_nameIself) :: Name) ->
   ...
   rule168 = \  (_ :: ()) ->
     emptySet
   {-# INLINE rule169 #-}
   rule169 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
...
sem_Import_TypeOrClass arg_range_ arg_name_ arg_names_ = T_Import (return st68) where
   ...
   !st68 = let
      ...
      v67 = \ !(T_Import_vIn67 ) -> ( let
         ...
         (T_MaybeNames_vOut106 _namesInames _namesIself) = inv_MaybeNames_s107 _namesX107 (T_MaybeNames_vIn106 )
         _lhsOtypeorclasses :: IdSet
         _lhsOtypeorclasses = rule171 _nameIself
         _lhsOconfieldormethods :: IdSet
         _lhsOconfieldormethods = rule172 _namesInames
         _lhsOtypeorclassesCompl :: IdSet
         _lhsOtypeorclassesCompl = rule173  ()
         _lhsOvalues :: IdSet
         _lhsOvalues = rule174  ()
         _self = rule175 _nameIself _namesIself _rangeIself
         _lhsOself :: Import
     ...
     in C_Import_s68 v67
   {-# INLINE rule171 #-}
   rule171 = \ ((_nameIself) :: Name) ->
                                                         singleSet (idFromName _nameIself)
   {-# INLINE rule172 #-}
   rule172 = \ ((_namesInames) ::  Maybe [Name] ) ->
   ...
   rule174 = \  (_ :: ()) ->
     emptySet
   {-# INLINE rule175 #-}
   rule175 = \ ((_nameIself) :: Name) ((_namesIself) :: MaybeNames) ((_rangeIself) :: Range) ->
...
sem_Import_TypeOrClassComplete arg_range_ arg_name_ = T_Import (return st68) where
   ...
   !st68 = let
      ...
      v67 = \ !(T_Import_vIn67 ) -> ( let
         ...
         (T_Name_vOut112 _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _lhsOtypeorclassesCompl :: IdSet
         _lhsOtypeorclassesCompl = rule177 _nameIself
         _lhsOconfieldormethods :: IdSet
         _lhsOconfieldormethods = rule178  ()
         _lhsOtypeorclasses :: IdSet
         _lhsOtypeorclasses = rule179  ()
         _lhsOvalues :: IdSet
         _lhsOvalues = rule180  ()
...
data Syn_ImportDeclaration  = Syn_ImportDeclaration { coreImportDecls_Syn_ImportDeclaration :: !( [ImportList] ), self_Syn_ImportDeclaration :: !(ImportDeclaration) }
...
data T_ImportDeclaration_vOut70  = T_ImportDeclaration_vOut70 ( [ImportList] ) (ImportDeclaration)
...
sem_ImportDeclaration_Import arg_range_ !arg_qualified_ arg_name_ arg_asname_ arg_importspecification_ = T_ImportDeclaration (return st71) where
   ...
   !st71 = let
      ...
      v70 = \ !(T_ImportDeclaration_vIn70 ) -> ( let
         ...
         (T_MaybeImportSpecification_vOut97 _importspecificationIconfieldormethods _importspecificationIimportspec _importspecificationIself _importspecificationItypeorclasses _importspecificationItypeorclassesCompl _importspecificationIvalues) = inv_MaybeImportSpecification_s98 _importspecificationX98 (T_MaybeImportSpecification_vIn97 )
         _lhsOcoreImportDecls ::  [ImportList] 
         _lhsOcoreImportDecls = rule183 _asnameIname _importDecls _importspecificationIconfieldormethods _importspecificationIimportspec _importspecificationItypeorclasses _importspecificationItypeorclassesCompl _importspecificationIvalues _nameIself arg_qualified_
         _importDecls = rule184 _nameIself
         _self = rule185 _asnameIself _importspecificationIself _nameIself _rangeIself arg_qualified_
   ...
   {-# INLINE rule183 #-}
   rule183 = \ ((_asnameIname) ::  Maybe Name ) _importDecls ((_importspecificationIconfieldormethods) :: IdSet) ((_importspecificationIimportspec) :: Maybe Bool) ((_importspecificationItypeorclasses) :: IdSet) ((_importspecificationItypeorclassesCompl) :: IdSet) ((_importspecificationIvalues) :: IdSet) ((_nameIself) :: Name) qualified_ ->
                                [( _importDecls
                                 , _importspecificationIimportspec
                                 , qualified_
                                 , fromMaybe _nameIself _asnameIname
                                 , _importspecificationIvalues
                                 , _importspecificationIconfieldormethods
                                 , _importspecificationItypeorclassesCompl
                                 , _importspecificationItypeorclasses
                                 , _nameIself)]
   {-# INLINE rule184 #-}
   rule184 = \ ((_nameIself) :: Name) ->
              Core.DeclImport
   ...
   {-# INLINE rule185 #-}
   rule185 = \ ((_asnameIself) :: MaybeName) ((_importspecificationIself) :: MaybeImportSpecification) ((_nameIself) :: Name) ((_rangeIself) :: Range) qualified_ ->
...
sem_ImportDeclaration_Empty arg_range_ = T_ImportDeclaration (return st71) where
   ...
   !st71 = let
      ...
      v70 = \ !(T_ImportDeclaration_vIn70 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         _lhsOcoreImportDecls ::  [ImportList] 
         _lhsOcoreImportDecls = rule187  ()
         _self = rule188 _rangeIself
         _lhsOself :: ImportDeclaration
...
data Syn_ImportDeclarations  = Syn_ImportDeclarations { coreImportDecls_Syn_ImportDeclarations :: !( [ImportList] ), self_Syn_ImportDeclarations :: !(ImportDeclarations) }
...
data T_ImportDeclarations_vOut73  = T_ImportDeclarations_vOut73 ( [ImportList] ) (ImportDeclarations)
...
sem_ImportDeclarations_Cons arg_hd_ arg_tl_ = T_ImportDeclarations (return st74) where
   ...
   !st74 = let
      ...
      v73 = \ !(T_ImportDeclarations_vIn73 ) -> ( let
         ...
         _lhsOcoreImportDecls ::  [ImportList] 
         _lhsOcoreImportDecls = rule190 _hdIcoreImportDecls _tlIcoreImportDecls
   ...
   {-# INLINE rule190 #-}
   rule190 = \ ((_hdIcoreImportDecls) ::  [ImportList] ) ((_tlIcoreImportDecls) ::  [ImportList] ) ->
...
data Syn_ImportSpecification  = Syn_ImportSpecification { confieldormethods_Syn_ImportSpecification :: !(IdSet), importspec_Syn_ImportSpecification :: !(Maybe Bool), self_Syn_ImportSpecification :: !(ImportSpecification), typeorclasses_Syn_ImportSpecification :: !(IdSet), typeorclassesCompl_Syn_ImportSpecification :: !(IdSet), values_Syn_ImportSpecification :: !(IdSet) }
...
wrap_ImportSpecification !(T_ImportSpecification act) !(Inh_ImportSpecification ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_ImportSpecification_vOut76 _lhsOconfieldormethods _lhsOimportspec _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues) <- return (inv_ImportSpecification_s77 sem arg76)
        return (Syn_ImportSpecification _lhsOconfieldormethods _lhsOimportspec _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues)
   )
...
data T_ImportSpecification_vOut76  = T_ImportSpecification_vOut76 (IdSet) (Maybe Bool) (ImportSpecification) (IdSet) (IdSet) (IdSet)
...
sem_ImportSpecification_Import arg_range_ !arg_hiding_ arg_imports_ = T_ImportSpecification (return st77) where
   ...
   !st77 = let
      ...
      v76 = \ !(T_ImportSpecification_vIn76 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Imports_vOut79 _importsIconfieldormethods _importsIself _importsItypeorclasses _importsItypeorclassesCompl _importsIvalues) = inv_Imports_s80 _importsX80 (T_Imports_vIn79 )
         _lhsOimportspec :: Maybe Bool
         _lhsOimportspec = rule196 arg_hiding_
         _lhsOconfieldormethods :: IdSet
         _lhsOconfieldormethods = rule197 _importsIconfieldormethods
         _lhsOtypeorclasses :: IdSet
         _lhsOtypeorclasses = rule198 _importsItypeorclasses
         _lhsOtypeorclassesCompl :: IdSet
         _lhsOtypeorclassesCompl = rule199 _importsItypeorclassesCompl
         _lhsOvalues :: IdSet
         _lhsOvalues = rule200 _importsIvalues
         _self = rule201 _importsIself _rangeIself arg_hiding_
         _lhsOself :: ImportSpecification
         _lhsOself = rule202 _self
         !__result_ = T_ImportSpecification_vOut76 _lhsOconfieldormethods _lhsOimportspec _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues
         in __result_ )
   ...
   rule196 = \ hiding_ ->
                                Just hiding_
   {-# INLINE rule197 #-}
   rule197 = \ ((_importsIconfieldormethods) :: IdSet) ->
     _importsIconfieldormethods
   {-# INLINE rule198 #-}
   rule198 = \ ((_importsItypeorclasses) :: IdSet) ->
     _importsItypeorclasses
   {-# INLINE rule199 #-}
   rule199 = \ ((_importsItypeorclassesCompl) :: IdSet) ->
     _importsItypeorclassesCompl
   {-# INLINE rule200 #-}
   rule200 = \ ((_importsIvalues) :: IdSet) ->
     _importsIvalues
   {-# INLINE rule201 #-}
   rule201 = \ ((_importsIself) :: Imports) ((_rangeIself) :: Range) hiding_ ->
...
data Syn_Imports  = Syn_Imports { confieldormethods_Syn_Imports :: !(IdSet), self_Syn_Imports :: !(Imports), typeorclasses_Syn_Imports :: !(IdSet), typeorclassesCompl_Syn_Imports :: !(IdSet), values_Syn_Imports :: !(IdSet) }
...
wrap_Imports !(T_Imports act) !(Inh_Imports ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_Imports_vOut79 _lhsOconfieldormethods _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues) <- return (inv_Imports_s80 sem arg79)
        return (Syn_Imports _lhsOconfieldormethods _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues)
   )
...
data T_Imports_vOut79  = T_Imports_vOut79 (IdSet) (Imports) (IdSet) (IdSet) (IdSet)
...
sem_Imports_Cons arg_hd_ arg_tl_ = T_Imports (return st80) where
   ...
   !st80 = let
      ...
      v79 = \ !(T_Imports_vIn79 ) -> ( let
         ...
         (T_Import_vOut67 _hdIconfieldormethods _hdIself _hdItypeorclasses _hdItypeorclassesCompl _hdIvalues) = inv_Import_s68 _hdX68 (T_Import_vIn67 )
         (T_Imports_vOut79 _tlIconfieldormethods _tlIself _tlItypeorclasses _tlItypeorclassesCompl _tlIvalues) = inv_Imports_s80 _tlX80 (T_Imports_vIn79 )
         _lhsOconfieldormethods :: IdSet
         _lhsOconfieldormethods = rule203 _hdIconfieldormethods _tlIconfieldormethods
         _lhsOtypeorclasses :: IdSet
         _lhsOtypeorclasses = rule204 _hdItypeorclasses _tlItypeorclasses
         _lhsOtypeorclassesCompl :: IdSet
         _lhsOtypeorclassesCompl = rule205 _hdItypeorclassesCompl _tlItypeorclassesCompl
         _lhsOvalues :: IdSet
         _lhsOvalues = rule206 _hdIvalues _tlIvalues
         _self = rule207 _hdIself _tlIself
         _lhsOself :: Imports
         _lhsOself = rule208 _self
         !__result_ = T_Imports_vOut79 _lhsOconfieldormethods _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues
         in __result_ )
     in C_Imports_s80 v79
   {-# INLINE rule203 #-}
   rule203 = \ ((_hdIconfieldormethods) :: IdSet) ((_tlIconfieldormethods) :: IdSet) ->
     _hdIconfieldormethods  `unionSet`  _tlIconfieldormethods
   {-# INLINE rule204 #-}
   rule204 = \ ((_hdItypeorclasses) :: IdSet) ((_tlItypeorclasses) :: IdSet) ->
     _hdItypeorclasses  `unionSet`  _tlItypeorclasses
   {-# INLINE rule205 #-}
   rule205 = \ ((_hdItypeorclassesCompl) :: IdSet) ((_tlItypeorclassesCompl) :: IdSet) ->
     _hdItypeorclassesCompl  `unionSet`  _tlItypeorclassesCompl
   {-# INLINE rule206 #-}
   rule206 = \ ((_hdIvalues) :: IdSet) ((_tlIvalues) :: IdSet) ->
...
sem_Imports_Nil  = T_Imports (return st80) where
   ...
   !st80 = let
      ...
      v79 = \ !(T_Imports_vIn79 ) -> ( let
         _lhsOconfieldormethods :: IdSet
         _lhsOconfieldormethods = rule209  ()
         _lhsOtypeorclasses :: IdSet
         _lhsOtypeorclasses = rule210  ()
         _lhsOtypeorclassesCompl :: IdSet
         _lhsOtypeorclassesCompl = rule211  ()
         _lhsOvalues :: IdSet
         _lhsOvalues = rule212  ()
         _self = rule213  ()
         _lhsOself :: Imports
...
sem_LeftHandSide_Function arg_range_ arg_name_ arg_patterns_ = T_LeftHandSide (return st83) where
   ...
   !st83 = let
      ...
      v82 = \ !(T_LeftHandSide_vIn82 ) -> ( let
         ...
         (T_Patterns_vOut121 _patternsIself) = inv_Patterns_s122 _patternsX122 (T_Patterns_vIn121 )
         _lhsOname :: Name
         _lhsOname = rule215 _nameIself
         _self = rule216 _nameIself _patternsIself _rangeIself
   ...
   {-# INLINE rule215 #-}
   rule215 = \ ((_nameIself) :: Name) ->
                             _nameIself
   {-# INLINE rule216 #-}
   rule216 = \ ((_nameIself) :: Name) ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
...
sem_LeftHandSide_Infix arg_range_ arg_leftPattern_ arg_operator_ arg_rightPattern_ = T_LeftHandSide (return st83) where
   ...
   !st83 = let
      ...
      v82 = \ !(T_LeftHandSide_vIn82 ) -> ( let
         ...
         _lhsOname :: Name
         _lhsOname = rule218 _operatorIself
         _self = rule219 _leftPatternIself _operatorIself _rangeIself _rightPatternIself
         _lhsOself :: LeftHandSide
     ...
     in C_LeftHandSide_s83 v82
   {-# INLINE rule218 #-}
   rule218 = \ ((_operatorIself) :: Name) ->
                             _operatorIself
   {-# INLINE rule219 #-}
   rule219 = \ ((_leftPatternIself) :: Pattern) ((_operatorIself) :: Name) ((_rangeIself) :: Range) ((_rightPatternIself) :: Pattern) ->
...
sem_LeftHandSide_Parenthesized arg_range_ arg_lefthandside_ arg_patterns_ = T_LeftHandSide (return st83) where
   ...
   !st83 = let
      ...
      v82 = \ !(T_LeftHandSide_vIn82 ) -> ( let
         ...
         (T_LeftHandSide_vOut82 _lefthandsideIname _lefthandsideIself) = inv_LeftHandSide_s83 _lefthandsideX83 (T_LeftHandSide_vIn82 )
         (T_Patterns_vOut121 _patternsIself) = inv_Patterns_s122 _patternsX122 (T_Patterns_vIn121 )
         _self = rule221 _lefthandsideIself _patternsIself _rangeIself
         _lhsOself :: LeftHandSide
         _lhsOself = rule222 _self
         _lhsOname :: Name
         _lhsOname = rule223 _lefthandsideIname
         !__result_ = T_LeftHandSide_vOut82 _lhsOname _lhsOself
         in __result_ )
     in C_LeftHandSide_s83 v82
   {-# INLINE rule221 #-}
   rule221 = \ ((_lefthandsideIself) :: LeftHandSide) ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
     LeftHandSide_Parenthesized _rangeIself _lefthandsideIself _patternsIself
   {-# INLINE rule222 #-}
   rule222 = \ _self ->
     _self
   {-# INLINE rule223 #-}
   rule223 = \ ((_lefthandsideIname) :: Name) ->
     _lefthandsideIname
...
sem_MaybeExpression_Just arg_expression_ = T_MaybeExpression (return st95) where
   ...
   !st95 = let
      ...
      v94 = \ !(T_MaybeExpression_vIn94 ) -> ( let
         _expressionX41 = Control.Monad.Identity.runIdentity (attach_T_Expression (arg_expression_))
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule242 _expressionIself
         _lhsOself :: MaybeExpression
     ...
     in C_MaybeExpression_s95 v94
   {-# INLINE rule242 #-}
   rule242 = \ ((_expressionIself) :: Expression) ->
...
data Syn_MaybeImportSpecification  = Syn_MaybeImportSpecification { confieldormethods_Syn_MaybeImportSpecification :: !(IdSet), importspec_Syn_MaybeImportSpecification :: !(Maybe Bool), self_Syn_MaybeImportSpecification :: !(MaybeImportSpecification), typeorclasses_Syn_MaybeImportSpecification :: !(IdSet), typeorclassesCompl_Syn_MaybeImportSpecification :: !(IdSet), values_Syn_MaybeImportSpecification :: !(IdSet) }
...
wrap_MaybeImportSpecification !(T_MaybeImportSpecification act) !(Inh_MaybeImportSpecification ) =
   Control.Monad.Identity.runIdentity (
     do !sem <- act
        ...
        !(T_MaybeImportSpecification_vOut97 _lhsOconfieldormethods _lhsOimportspec _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues) <- return (inv_MaybeImportSpecification_s98 sem arg97)
        return (Syn_MaybeImportSpecification _lhsOconfieldormethods _lhsOimportspec _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues)
   )
...
data T_MaybeImportSpecification_vOut97  = T_MaybeImportSpecification_vOut97 (IdSet) (Maybe Bool) (MaybeImportSpecification) (IdSet) (IdSet) (IdSet)
...
sem_MaybeImportSpecification_Nothing  = T_MaybeImportSpecification (return st98) where
   ...
   !st98 = let
      ...
      v97 = \ !(T_MaybeImportSpecification_vIn97 ) -> ( let
         _lhsOimportspec :: Maybe Bool
         _lhsOimportspec = rule244  ()
         _lhsOconfieldormethods :: IdSet
         _lhsOconfieldormethods = rule245  ()
         _lhsOtypeorclasses :: IdSet
         _lhsOtypeorclasses = rule246  ()
         _lhsOtypeorclassesCompl :: IdSet
         _lhsOtypeorclassesCompl = rule247  ()
         _lhsOvalues :: IdSet
         _lhsOvalues = rule248  ()
         _self = rule249  ()
         _lhsOself :: MaybeImportSpecification
         _lhsOself = rule250 _self
         !__result_ = T_MaybeImportSpecification_vOut97 _lhsOconfieldormethods _lhsOimportspec _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues
         in __result_ )
...
sem_MaybeImportSpecification_Just arg_importspecification_ = T_MaybeImportSpecification (return st98) where
   ...
   !st98 = let
      ...
      v97 = \ !(T_MaybeImportSpecification_vIn97 ) -> ( let
         ...
         (T_ImportSpecification_vOut76 _importspecificationIconfieldormethods _importspecificationIimportspec _importspecificationIself _importspecificationItypeorclasses _importspecificationItypeorclassesCompl _importspecificationIvalues) = inv_ImportSpecification_s77 _importspecificationX77 (T_ImportSpecification_vIn76 )
         _lhsOconfieldormethods :: IdSet
         _lhsOconfieldormethods = rule251 _importspecificationIconfieldormethods
         _lhsOtypeorclasses :: IdSet
         _lhsOtypeorclasses = rule252 _importspecificationItypeorclasses
         _lhsOtypeorclassesCompl :: IdSet
         _lhsOtypeorclassesCompl = rule253 _importspecificationItypeorclassesCompl
         _lhsOvalues :: IdSet
         _lhsOvalues = rule254 _importspecificationIvalues
         _self = rule255 _importspecificationIself
         _lhsOself :: MaybeImportSpecification
         _lhsOself = rule256 _self
         _lhsOimportspec :: Maybe Bool
         _lhsOimportspec = rule257 _importspecificationIimportspec
         !__result_ = T_MaybeImportSpecification_vOut97 _lhsOconfieldormethods _lhsOimportspec _lhsOself _lhsOtypeorclasses _lhsOtypeorclassesCompl _lhsOvalues
         in __result_ )
     in C_MaybeImportSpecification_s98 v97
   {-# INLINE rule251 #-}
   rule251 = \ ((_importspecificationIconfieldormethods) :: IdSet) ->
     _importspecificationIconfieldormethods
   {-# INLINE rule252 #-}
   rule252 = \ ((_importspecificationItypeorclasses) :: IdSet) ->
     _importspecificationItypeorclasses
   {-# INLINE rule253 #-}
   rule253 = \ ((_importspecificationItypeorclassesCompl) :: IdSet) ->
     _importspecificationItypeorclassesCompl
   {-# INLINE rule254 #-}
   rule254 = \ ((_importspecificationIvalues) :: IdSet) ->
     _importspecificationIvalues
   {-# INLINE rule255 #-}
   rule255 = \ ((_importspecificationIself) :: ImportSpecification) ->
     MaybeImportSpecification_Just _importspecificationIself
   {-# INLINE rule256 #-}
   rule256 = \ _self ->
     _self
   {-# INLINE rule257 #-}
   rule257 = \ ((_importspecificationIimportspec) :: Maybe Bool) ->
     _importspecificationIimportspec
...
sem_MaybeName_Just arg_name_ = T_MaybeName (return st104) where
   ...
   !st104 = let
      ...
      v103 = \ !(T_MaybeName_vIn103 ) -> ( let
         ...
         (T_Name_vOut112 _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _lhsOisNothing :: Bool
         _lhsOisNothing = rule266  ()
         _lhsOname ::  Maybe Name 
         _lhsOname = rule267 _nameIself
         _self = rule268 _nameIself
         _lhsOself :: MaybeName
...
sem_MaybeNames_Just arg_names_ = T_MaybeNames (return st107) where
   ...
   !st107 = let
      ...
      v106 = \ !(T_MaybeNames_vIn106 ) -> ( let
         ...
         (T_Names_vOut115 _namesInames _namesIself) = inv_Names_s116 _namesX116 (T_Names_vIn115 )
         _lhsOnames ::  Maybe [Name] 
         _lhsOnames = rule273 _namesInames
         _self = rule274 _namesIself
         _lhsOself :: MaybeNames
     ...
     in C_MaybeNames_s107 v106
   {-# INLINE rule273 #-}
   rule273 = \ ((_namesInames) :: [Name]) ->
                                        Just _namesInames
   {-# INLINE rule274 #-}
   rule274 = \ ((_namesIself) :: Names) ->
...
data Syn_Module  = Syn_Module { coreImportDecls_Syn_Module :: !( [ImportList] ), self_Syn_Module :: !(Module) }
...
data T_Module_vOut109  = T_Module_vOut109 ( [ImportList] ) (Module)
...
sem_Module_Module arg_range_ arg_name_ arg_exports_ arg_body_ = T_Module (return st110) where
   ...
   !st110 = let
      ...
      v109 = \ !(T_Module_vIn109 ) -> ( let
         ...
         _self = rule276 _bodyIself _exportsIself _nameIself _rangeIself
         _lhsOself :: Module
         _lhsOself = rule277 _self
         _lhsOcoreImportDecls ::  [ImportList] 
         _lhsOcoreImportDecls = rule278 _bodyIcoreImportDecls
         !__result_ = T_Module_vOut109 _lhsOcoreImportDecls _lhsOself
         in __result_ )
     in C_Module_s110 v109
   {-# INLINE rule276 #-}
   rule276 = \ ((_bodyIself) :: Body) ((_exportsIself) :: MaybeExports) ((_nameIself) :: MaybeName) ((_rangeIself) :: Range) ->
     Module_Module _rangeIself _nameIself _exportsIself _bodyIself
   {-# INLINE rule277 #-}
   rule277 = \ _self ->
     _self
   {-# INLINE rule278 #-}
   rule278 = \ ((_bodyIcoreImportDecls) ::  [ImportList] ) ->
...
sem_Name_Identifier arg_range_ arg_module_ !arg_origin_ !arg_name_ = T_Name (return st113) where
   ...
   !st113 = let
      ...
      v112 = \ !(T_Name_vIn112 ) -> ( let
         ...
         _self = rule279 _moduleIself _rangeIself arg_name_ arg_origin_
         _lhsOself :: Name
     ...
     in C_Name_s113 v112
   {-# INLINE rule279 #-}
   rule279 = \ ((_moduleIself) :: Strings) ((_rangeIself) :: Range) name_ origin_ ->
...
sem_Name_Operator arg_range_ arg_module_ !arg_origin_ !arg_name_ = T_Name (return st113) where
   ...
   !st113 = let
      ...
      v112 = \ !(T_Name_vIn112 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Strings_vOut160 _moduleIself) = inv_Strings_s161 _moduleX161 (T_Strings_vIn160 )
         _self = rule281 _moduleIself _rangeIself arg_name_ arg_origin_
         _lhsOself :: Name
     ...
     in C_Name_s113 v112
   {-# INLINE rule281 #-}
   rule281 = \ ((_moduleIself) :: Strings) ((_rangeIself) :: Range) name_ origin_ ->
...
sem_Name_Special arg_range_ arg_module_ !arg_origin_ !arg_name_ = T_Name (return st113) where
   ...
   !st113 = let
      ...
      v112 = \ !(T_Name_vIn112 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Strings_vOut160 _moduleIself) = inv_Strings_s161 _moduleX161 (T_Strings_vIn160 )
         _self = rule283 _moduleIself _rangeIself arg_name_ arg_origin_
         _lhsOself :: Name
     ...
     in C_Name_s113 v112
   {-# INLINE rule283 #-}
   rule283 = \ ((_moduleIself) :: Strings) ((_rangeIself) :: Range) name_ origin_ ->
...
sem_Names_Cons arg_hd_ arg_tl_ = T_Names (return st116) where
   ...
   !st116 = let
      ...
      v115 = \ !(T_Names_vIn115 ) -> ( let
         ...
         _lhsOnames :: [Name]
         _lhsOnames = rule285 _hdIself _tlInames
         _self = rule286 _hdIself _tlIself
         _lhsOself :: Names
   ...
   {-# INLINE rule285 #-}
   rule285 = \ ((_hdIself) :: Name) ((_tlInames) :: [Name]) ->
                             _hdIself : _tlInames
   {-# INLINE rule286 #-}
   rule286 = \ ((_hdIself) :: Name) ((_tlIself) :: Names) ->
     (:) _hdIself _tlIself
   {-# INLINE rule287 #-}
   rule287 = \ _self ->
     _self
...
sem_Pattern_Hole arg_range_ !arg_id_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         _rangeX134 = Control.Monad.Identity.runIdentity (attach_T_Range (arg_range_))
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         _self = rule291 _rangeIself arg_id_
         _lhsOself :: Pattern
...
sem_Pattern_Literal arg_range_ arg_literal_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Literal_vOut85 _literalIself) = inv_Literal_s86 _literalX86 (T_Literal_vIn85 )
         _self = rule293 _literalIself _rangeIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule293 #-}
   rule293 = \ ((_literalIself) :: Literal) ((_rangeIself) :: Range) ->
...
sem_Pattern_Variable arg_range_ arg_name_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Name_vOut112 _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _self = rule295 _nameIself _rangeIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule295 #-}
   rule295 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
...
sem_Pattern_Constructor arg_range_ arg_name_ arg_patterns_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Name_vOut112 _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_Patterns_vOut121 _patternsIself) = inv_Patterns_s122 _patternsX122 (T_Patterns_vIn121 )
         _self = rule297 _nameIself _patternsIself _rangeIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule297 #-}
   rule297 = \ ((_nameIself) :: Name) ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
...
sem_Pattern_Parenthesized arg_range_ arg_pattern_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Pattern_vOut118 _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         _self = rule299 _patternIself _rangeIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule299 #-}
   rule299 = \ ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
...
sem_Pattern_InfixConstructor arg_range_ arg_leftPattern_ arg_constructorOperator_ arg_rightPattern_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Name_vOut112 _constructorOperatorIself) = inv_Name_s113 _constructorOperatorX113 (T_Name_vIn112 )
         (T_Pattern_vOut118 _rightPatternIself) = inv_Pattern_s119 _rightPatternX119 (T_Pattern_vIn118 )
         _self = rule301 _constructorOperatorIself _leftPatternIself _rangeIself _rightPatternIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule301 #-}
   rule301 = \ ((_constructorOperatorIself) :: Name) ((_leftPatternIself) :: Pattern) ((_rangeIself) :: Range) ((_rightPatternIself) :: Pattern) ->
...
sem_Pattern_List arg_range_ arg_patterns_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Patterns_vOut121 _patternsIself) = inv_Patterns_s122 _patternsX122 (T_Patterns_vIn121 )
         _self = rule303 _patternsIself _rangeIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule303 #-}
   rule303 = \ ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
...
sem_Pattern_Tuple arg_range_ arg_patterns_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Patterns_vOut121 _patternsIself) = inv_Patterns_s122 _patternsX122 (T_Patterns_vIn121 )
         _self = rule305 _patternsIself _rangeIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule305 #-}
   rule305 = \ ((_patternsIself) :: Patterns) ((_rangeIself) :: Range) ->
...
sem_Pattern_Record arg_range_ arg_name_ arg_recordPatternBindings_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         _self = rule307 _nameIself _rangeIself _recordPatternBindingsIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule307 #-}
   rule307 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ((_recordPatternBindingsIself) :: RecordPatternBindings) ->
...
sem_Pattern_Negate arg_range_ arg_literal_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Literal_vOut85 _literalIself) = inv_Literal_s86 _literalX86 (T_Literal_vIn85 )
         _self = rule309 _literalIself _rangeIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule309 #-}
   rule309 = \ ((_literalIself) :: Literal) ((_rangeIself) :: Range) ->
...
sem_Pattern_As arg_range_ arg_name_ arg_pattern_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Name_vOut112 _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_Pattern_vOut118 _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         _self = rule311 _nameIself _patternIself _rangeIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule311 #-}
   rule311 = \ ((_nameIself) :: Name) ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
...
sem_Pattern_Irrefutable arg_range_ arg_pattern_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Pattern_vOut118 _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         _self = rule315 _patternIself _rangeIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule315 #-}
   rule315 = \ ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
...
sem_Pattern_Successor arg_range_ arg_name_ arg_literal_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Name_vOut112 _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_Literal_vOut85 _literalIself) = inv_Literal_s86 _literalX86 (T_Literal_vIn85 )
         _self = rule317 _literalIself _nameIself _rangeIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule317 #-}
   rule317 = \ ((_literalIself) :: Literal) ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
...
sem_Pattern_NegateFloat arg_range_ arg_literal_ = T_Pattern (return st119) where
   ...
   !st119 = let
      ...
      v118 = \ !(T_Pattern_vIn118 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Literal_vOut85 _literalIself) = inv_Literal_s86 _literalX86 (T_Literal_vIn85 )
         _self = rule319 _literalIself _rangeIself
         _lhsOself :: Pattern
     ...
     in C_Pattern_s119 v118
   {-# INLINE rule319 #-}
   rule319 = \ ((_literalIself) :: Literal) ((_rangeIself) :: Range) ->
...
sem_Patterns_Cons arg_hd_ arg_tl_ = T_Patterns (return st122) where
   ...
   !st122 = let
      ...
      v121 = \ !(T_Patterns_vIn121 ) -> ( let
         ...
         _self = rule321 _hdIself _tlIself
         _lhsOself :: Patterns
   ...
   {-# INLINE rule321 #-}
   rule321 = \ ((_hdIself) :: Pattern) ((_tlIself) :: Patterns) ->
     (:) _hdIself _tlIself
   {-# INLINE rule322 #-}
   rule322 = \ _self ->
     _self
...
sem_Position_Position !arg_filename_ !arg_line_ !arg_column_ = T_Position (return st125) where
   ...
   !st125 = let
      ...
      v124 = \ !(T_Position_vIn124 ) -> ( let
         _self = rule325 arg_column_ arg_filename_ arg_line_
         _lhsOself :: Position
   ...
   {-# INLINE rule325 #-}
   rule325 = \ column_ filename_ line_ ->
...
sem_Qualifier_Guard arg_range_ arg_guard_ = T_Qualifier (return st128) where
   ...
   !st128 = let
      ...
      v127 = \ !(T_Qualifier_vIn127 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expression_vOut40 _guardIself) = inv_Expression_s41 _guardX41 (T_Expression_vIn40 )
         _self = rule329 _guardIself _rangeIself
         _lhsOself :: Qualifier
   ...
   {-# INLINE rule329 #-}
   rule329 = \ ((_guardIself) :: Expression) ((_rangeIself) :: Range) ->
...
sem_Qualifier_Let arg_range_ arg_declarations_ = T_Qualifier (return st128) where
   ...
   !st128 = let
      ...
      v127 = \ !(T_Qualifier_vIn127 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Declarations_vOut31 _declarationsIself) = inv_Declarations_s32 _declarationsX32 (T_Declarations_vIn31 )
         _self = rule331 _declarationsIself _rangeIself
         _lhsOself :: Qualifier
     ...
     in C_Qualifier_s128 v127
   {-# INLINE rule331 #-}
   rule331 = \ ((_declarationsIself) :: Declarations) ((_rangeIself) :: Range) ->
...
sem_Qualifier_Generator arg_range_ arg_pattern_ arg_expression_ = T_Qualifier (return st128) where
   ...
   !st128 = let
      ...
      v127 = \ !(T_Qualifier_vIn127 ) -> ( let
         ...
         (T_Pattern_vOut118 _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule333 _expressionIself _patternIself _rangeIself
         _lhsOself :: Qualifier
     ...
     in C_Qualifier_s128 v127
   {-# INLINE rule333 #-}
   rule333 = \ ((_expressionIself) :: Expression) ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
...
sem_Qualifiers_Cons arg_hd_ arg_tl_ = T_Qualifiers (return st131) where
   ...
   {-# INLINE rule337 #-}
   rule337 = \ ((_hdIself) :: Qualifier) ((_tlIself) :: Qualifiers) ->
     (:) _hdIself _tlIself
   {-# INLINE rule338 #-}
   rule338 = \ _self ->
     _self
...
sem_Range_Range arg_start_ arg_stop_ = T_Range (return st134) where
   ...
   !st134 = let
      ...
      v133 = \ !(T_Range_vIn133 ) -> ( let
         ...
         _self = rule341 _startIself _stopIself
         _lhsOself :: Range
   ...
   {-# INLINE rule341 #-}
   rule341 = \ ((_startIself) :: Position) ((_stopIself) :: Position) ->
...
sem_RecordExpressionBinding_RecordExpressionBinding arg_range_ arg_name_ arg_expression_ = T_RecordExpressionBinding (return st137) where
   ...
   !st137 = let
      ...
      v136 = \ !(T_RecordExpressionBinding_vIn136 ) -> ( let
         ...
         (T_Name_vOut112 _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule343 _expressionIself _nameIself _rangeIself
   ...
   {-# INLINE rule343 #-}
   rule343 = \ ((_expressionIself) :: Expression) ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
...
sem_RecordExpressionBindings_Cons arg_hd_ arg_tl_ = T_RecordExpressionBindings (return st140) where
   ...
   !st140 = let
      ...
      v139 = \ !(T_RecordExpressionBindings_vIn139 ) -> ( let
         ...
         _self = rule345 _hdIself _tlIself
   ...
   {-# INLINE rule345 #-}
   rule345 = \ ((_hdIself) :: RecordExpressionBinding) ((_tlIself) :: RecordExpressionBindings) ->
     (:) _hdIself _tlIself
   {-# INLINE rule346 #-}
   rule346 = \ _self ->
     _self
...
sem_RecordPatternBinding_RecordPatternBinding arg_range_ arg_name_ arg_pattern_ = T_RecordPatternBinding (return st143) where
   ...
   !st143 = let
      ...
      v142 = \ !(T_RecordPatternBinding_vIn142 ) -> ( let
         ...
         (T_Name_vOut112 _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         (T_Pattern_vOut118 _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         _self = rule349 _nameIself _patternIself _rangeIself
   ...
   {-# INLINE rule349 #-}
   rule349 = \ ((_nameIself) :: Name) ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
...
sem_RecordPatternBindings_Cons arg_hd_ arg_tl_ = T_RecordPatternBindings (return st146) where
   ...
   {-# INLINE rule351 #-}
   rule351 = \ ((_hdIself) :: RecordPatternBinding) ((_tlIself) :: RecordPatternBindings) ->
     (:) _hdIself _tlIself
   {-# INLINE rule352 #-}
   rule352 = \ _self ->
     _self
...
sem_RightHandSide_Expression arg_range_ arg_expression_ arg_where_ = T_RightHandSide (return st149) where
   ...
   !st149 = let
      ...
      v148 = \ !(T_RightHandSide_vIn148 ) -> ( let
         ...
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         (T_MaybeDeclarations_vOut88 _whereIself) = inv_MaybeDeclarations_s89 _whereX89 (T_MaybeDeclarations_vIn88 )
         _self = rule355 _expressionIself _rangeIself _whereIself
   ...
   {-# INLINE rule355 #-}
   rule355 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ((_whereIself) :: MaybeDeclarations) ->
...
sem_RightHandSide_Guarded arg_range_ arg_guardedexpressions_ arg_where_ = T_RightHandSide (return st149) where
   ...
   !st149 = let
      ...
      v148 = \ !(T_RightHandSide_vIn148 ) -> ( let
         ...
         (T_MaybeDeclarations_vOut88 _whereIself) = inv_MaybeDeclarations_s89 _whereX89 (T_MaybeDeclarations_vIn88 )
         _self = rule357 _guardedexpressionsIself _rangeIself _whereIself
         _lhsOself :: RightHandSide
     ...
     in C_RightHandSide_s149 v148
   {-# INLINE rule357 #-}
   rule357 = \ ((_guardedexpressionsIself) :: GuardedExpressions) ((_rangeIself) :: Range) ((_whereIself) :: MaybeDeclarations) ->
...
sem_SimpleType_SimpleType arg_range_ arg_name_ arg_typevariables_ = T_SimpleType (return st152) where
   ...
   !st152 = let
      ...
      v151 = \ !(T_SimpleType_vIn151 ) -> ( let
         ...
         _self = rule359 _nameIself _rangeIself _typevariablesIself
   ...
   {-# INLINE rule359 #-}
   rule359 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ((_typevariablesIself) :: Names) ->
...
sem_Statement_Expression arg_range_ arg_expression_ = T_Statement (return st155) where
   ...
   !st155 = let
      ...
      v154 = \ !(T_Statement_vIn154 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule361 _expressionIself _rangeIself
         _lhsOself :: Statement
   ...
   {-# INLINE rule361 #-}
   rule361 = \ ((_expressionIself) :: Expression) ((_rangeIself) :: Range) ->
...
sem_Statement_Let arg_range_ arg_declarations_ = T_Statement (return st155) where
   ...
   !st155 = let
      ...
      v154 = \ !(T_Statement_vIn154 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Declarations_vOut31 _declarationsIself) = inv_Declarations_s32 _declarationsX32 (T_Declarations_vIn31 )
         _self = rule363 _declarationsIself _rangeIself
         _lhsOself :: Statement
     ...
     in C_Statement_s155 v154
   {-# INLINE rule363 #-}
   rule363 = \ ((_declarationsIself) :: Declarations) ((_rangeIself) :: Range) ->
...
sem_Statement_Generator arg_range_ arg_pattern_ arg_expression_ = T_Statement (return st155) where
   ...
   !st155 = let
      ...
      v154 = \ !(T_Statement_vIn154 ) -> ( let
         ...
         (T_Pattern_vOut118 _patternIself) = inv_Pattern_s119 _patternX119 (T_Pattern_vIn118 )
         (T_Expression_vOut40 _expressionIself) = inv_Expression_s41 _expressionX41 (T_Expression_vIn40 )
         _self = rule365 _expressionIself _patternIself _rangeIself
         _lhsOself :: Statement
     ...
     in C_Statement_s155 v154
   {-# INLINE rule365 #-}
   rule365 = \ ((_expressionIself) :: Expression) ((_patternIself) :: Pattern) ((_rangeIself) :: Range) ->
...
sem_Statements_Cons arg_hd_ arg_tl_ = T_Statements (return st158) where
   ...
   !st158 = let
      ...
      v157 = \ !(T_Statements_vIn157 ) -> ( let
         ...
         _self = rule369 _hdIself _tlIself
   ...
   {-# INLINE rule369 #-}
   rule369 = \ ((_hdIself) :: Statement) ((_tlIself) :: Statements) ->
     (:) _hdIself _tlIself
   {-# INLINE rule370 #-}
   rule370 = \ _self ->
     _self
...
sem_Strings_Cons !arg_hd_ arg_tl_ = T_Strings (return st161) where
   ...
   !st161 = let
      ...
      v160 = \ !(T_Strings_vIn160 ) -> ( let
         ...
         _self = rule373 _tlIself arg_hd_
         _lhsOself :: Strings
...
sem_Type_Application arg_range_ !arg_prefix_ arg_function_ arg_arguments_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         _self = rule377 _argumentsIself _functionIself _rangeIself arg_prefix_
         _lhsOself :: Type
     ...
     in C_Type_s164 v163
   {-# INLINE rule377 #-}
   rule377 = \ ((_argumentsIself) :: Types) ((_functionIself) :: Type) ((_rangeIself) :: Range) prefix_ ->
...
sem_Type_Variable arg_range_ arg_name_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Name_vOut112 _nameIself) = inv_Name_s113 _nameX113 (T_Name_vIn112 )
         _self = rule379 _nameIself _rangeIself
         _lhsOself :: Type
     ...
     in C_Type_s164 v163
   {-# INLINE rule379 #-}
   rule379 = \ ((_nameIself) :: Name) ((_rangeIself) :: Range) ->
...
sem_Type_Qualified arg_range_ arg_context_ arg_type_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         (T_ContextItems_vOut25 _contextIself) = inv_ContextItems_s26 _contextX26 (T_ContextItems_vIn25 )
         (T_Type_vOut163 _typeIself) = inv_Type_s164 _typeX164 (T_Type_vIn163 )
         _self = rule383 _contextIself _rangeIself _typeIself
         _lhsOself :: Type
     ...
     in C_Type_s164 v163
   {-# INLINE rule383 #-}
   rule383 = \ ((_contextIself) :: ContextItems) ((_rangeIself) :: Range) ((_typeIself) :: Type) ->
...
sem_Type_Exists arg_range_ arg_typevariables_ arg_type_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         (T_Names_vOut115 _typevariablesInames _typevariablesIself) = inv_Names_s116 _typevariablesX116 (T_Names_vIn115 )
         (T_Type_vOut163 _typeIself) = inv_Type_s164 _typeX164 (T_Type_vIn163 )
         _self = rule387 _rangeIself _typeIself _typevariablesIself
         _lhsOself :: Type
     ...
     in C_Type_s164 v163
   {-# INLINE rule387 #-}
   rule387 = \ ((_rangeIself) :: Range) ((_typeIself) :: Type) ((_typevariablesIself) :: Names) ->
...
sem_Type_Parenthesized arg_range_ arg_type_ = T_Type (return st164) where
   ...
   !st164 = let
      ...
      v163 = \ !(T_Type_vIn163 ) -> ( let
         ...
         (T_Range_vOut133 _rangeIself) = inv_Range_s134 _rangeX134 (T_Range_vIn133 )
         (T_Type_vOut163 _typeIself) = inv_Type_s164 _typeX164 (T_Type_vIn163 )
         _self = rule389 _rangeIself _typeIself
         _lhsOself :: Type
     ...
     in C_Type_s164 v163
   {-# INLINE rule389 #-}
   rule389 = \ ((_rangeIself) :: Range) ((_typeIself) :: Type) ->
...
sem_Types_Cons arg_hd_ arg_tl_ = T_Types (return st167) where
   ...
   !st167 = let
      ...
      v166 = \ !(T_Types_vIn166 ) -> ( let
         ...
         _self = rule391 _hdIself _tlIself
         _lhsOself :: Types
         _lhsOself = rule392 _self
         !__result_ = T_Types_vOut166 _lhsOself
         in __result_ )
     in C_Types_s167 v166
   {-# INLINE rule391 #-}
   rule391 = \ ((_hdIself) :: Type) ((_tlIself) :: Types) ->
     (:) _hdIself _tlIself
   {-# INLINE rule392 #-}
   rule392 = \ _self ->
     _self
